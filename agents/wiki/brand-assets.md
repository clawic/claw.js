...
Use the repository root `public/` directory as the single source of truth for shared brand images and shared UI fonts for internal dashboards and operational web apps.
