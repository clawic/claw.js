...
Publishing models the universal concept of "publish content to a destination" so that:

- Agents (via the `publishing` CLI) can author content, schedule it, queue it, fan it out to many destinations, and observe what happens.
