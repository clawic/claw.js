...
const { findCommand, findCommandFresh } = await import("./examples/showcase/src/lib/platform.ts");
const { getClawJSOpenClawStatus } = await import("./examples/showcase/src/lib/openclaw-agent.ts");
