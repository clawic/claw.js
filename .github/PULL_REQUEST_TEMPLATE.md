...
- [ ] I ran the relevant local gate (`npm run ci`, targeted checks, or the blocking E2E suite when behavior changed); GitHub does not run automatic checks for this repo.
