...
- [ ] I ran the relevant local gate (`npm run ci`, targeted checks, or the blocking E2E suite when behavior changed) and expect `CI` plus `Release Gate` to pass in GitHub.
