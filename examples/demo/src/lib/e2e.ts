    ...
    adapters: [
      ...
      },
      {
        ...
        capabilities: [
          ...
          { key: "session_gateway", supported: true, status: "ready", strategy: "gateway", source: "fixture", probeMethod: "fixture" },
          { key: "streaming", supported: true, status: "ready", strategy: "gateway", source: "fixture", probeMethod: "fixture" },
          { key: "sandbox", supported: true, status: "degraded", strategy: "native", source: "fixture", probeMethod: "fixture", limitations: ["V1 enforces workspace path boundaries and permission mode, not a full OS sandbox."] },
        ],
        providers: [
        ...
        channels: [],
        workspaceFiles: ["AGENTS", "TOOLS", "MEMORY"],
        limitations: [
          "V1 enforces workspace path boundaries and permission mode, not a full OS sandbox.",
        ],
        hasScheduler: false,
        hasMemory: true,
        hasSandbox: true,
        ...
        conversation: {
          ...
          sessionPath: path.join(process.cwd(), ".tmp", "e2e-claw-runtime-sessions"),
        },
      },
      {
        id: "codex",
