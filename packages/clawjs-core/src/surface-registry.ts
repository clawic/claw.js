...
export const clawSurfaceGraphEdges: ClawSurfaceEdge[] = [
  ...
  { id: "claw.edge.sync.owns.driveFiles", type: "owns", fromId: "claw.sync", toId: "claw.drive.files", owner: "claw", visibility: "public", contractId: "claw.api.sync.manifests", transport: "drive/files/blobs sync drivers", validation: "drive file sync hermetic E2E", source: surfaceRouteGraphSource },
...
export const clawSurfaceGraphRoutes: ClawSurfaceRoute[] = [
  ...
  },
  {
    ...
    summary: "Drive, files, documents, and blobs use configured sync drivers with explicit authority, cache policy, and conflict policy.",
    fromId: "claw.sync",
    toId: "claw.drive.files",
    owner: "claw",
    visibility: "public",
    transport: "Sync manifest/changelog plus files/blob drivers",
    validation: "Drive/file/blob sync tests",
