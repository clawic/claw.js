...
export const clawSurfaceGraphEdges: ClawSurfaceEdge[] = [
  ...
  { id: "claw.edge.system.telemetry.consumes.contextProviders", type: "consumes", fromId: "claw.systemTelemetry", toId: "claw.systemTelemetry.contextProviders", owner: "claw", visibility: "public", contractId: "claw.systemTelemetry.providers.v1", transport: "provider catalog, fail-closed provider plans, and local env/file provider values", validation: "System telemetry provider catalog tests", source: surfaceRouteGraphSource },
  ...
  { id: "claw.edge.system.telemetry.owns.audit", type: "owns", fromId: "claw.systemTelemetry", toId: "claw.host.audit", owner: "claw", visibility: "internal", contractId: "claw.systemTelemetry.controlAudit.v1", transport: "signed-host control receipt and redacted audit event", validation: "System telemetry control broker tests", source: surfaceRouteGraphSource },
