...
test("dense data OS centers have direct human CLI nouns and plural aliases", () => {
  ...
  const product = findClawDenseDataSystem("product");
  ...
  const content = findClawDenseDataSystem("content");
  ...
  const construction = findClawDenseDataSystem("construction");
...
test("dense data OS resolves direct CLI intent phrases without executing them", () => {
  ...
  const pimOverview = resolveClawDenseDataIntent("claw pim overview");
  ...
  const constructionProjectList = resolveClawDenseDataIntent("claw construction-project list");
  ...
  const productSpecList = resolveClawDenseDataIntent("claw product-spec list");
  ...
  const contentEntryList = resolveClawDenseDataIntent("claw content-entry list");
  ...
  const contentOverview = resolveClawDenseDataIntent("claw cms overview");
