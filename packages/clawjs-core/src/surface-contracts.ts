...
const clawPersistentSurfacePathMap: Readonly<Record<string, string>> = {
  ...
  "claw.workspace.sheets": ".claw/sheets",
  ...
  "claw.workspace.storage": ".claw/storage",
