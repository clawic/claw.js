...
export const clawCapabilityFiches: readonly ClawCapabilityFiche[] = [
  ...
  customAppFiche({ id: "jobs.list", system: "jobs", title: "Jobs list", summary: "Read recent framework jobs and run records through SDK/host adapters without starting or cancelling work.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["claw runtime jobs --json"], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "registered route", status: "deferred", reason: "Jobs list is a custom-app read projection; no dedicated route graph entry is required in the critical slice." }] }),
  customAppFiche({ id: "jobs.get", system: "jobs", title: "Jobs detail", summary: "Read one framework job/run detail with redacted entity summaries through SDK/host adapters.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "registered route", status: "deferred", reason: "Jobs detail is a custom-app read projection; no dedicated route graph entry is required in the critical slice." }] }),
  customAppFiche({ id: "jobs.events", system: "jobs", title: "Jobs events", summary: "Read job/run event summaries without granting custom apps a live stream.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "live stream", status: "deferred", reason: "Live stream execution is intentionally separated from read-only event summaries." }] }),
  customAppFiche({ id: "jobs.stream", system: "jobs", title: "Jobs stream", summary: "Blocked custom-app gap for true live job/run streams until stream backend, policy, audit, and host adapters exist.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["pending"], serviceApi: ["pending"], mcp: ["pending"], relay: ["pending"], hostBridge: ["blocked"], permissions: ["blocked until stream policy and audit exist"], errorStates: ["capability blocked", "no stream runner", "policy unavailable"], limits: ["No SDK execution", "No host bridge execution"], gaps: [{ area: "execution", status: "blocked", reason: "No live stream backend, policy, audit, or host adapter exists yet." }] }),
  customAppFiche({ id: "jobs.start", system: "jobs", title: "Jobs start", summary: "Blocked custom-app gap for starting jobs until runner policy, audit, and host adapters exist.", operation: "action", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["pending"], serviceApi: ["pending"], mcp: ["pending"], relay: ["pending"], hostBridge: ["blocked"], permissions: ["blocked until job start policy and audit exist"], errorStates: ["capability blocked", "no start runner", "policy unavailable"], limits: ["No SDK execution", "No host bridge execution", "No job mutation"], gaps: [{ area: "execution", status: "blocked", reason: "No approved job start runner, policy, audit, or host adapter exists yet." }] }),
  customAppFiche({ id: "jobs.cancel", system: "jobs", title: "Jobs cancel", summary: "Blocked custom-app gap for cancelling jobs until runner policy, audit, and host adapters exist.", operation: "action", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["pending"], serviceApi: ["pending"], mcp: ["pending"], relay: ["pending"], hostBridge: ["blocked"], permissions: ["blocked until job cancel policy and audit exist"], errorStates: ["capability blocked", "no cancel runner", "policy unavailable"], limits: ["No SDK execution", "No host bridge execution", "No job cancellation"], gaps: [{ area: "execution", status: "blocked", reason: "No approved job cancel runner, policy, audit, or host adapter exists yet." }] }),
