...
export const clawCapabilityFiches: readonly ClawCapabilityFiche[] = [
  ...
  customAppFiche({ id: "jobs.list", system: "jobs", title: "Jobs list", summary: "Read recent framework jobs and run records through SDK/host adapters without starting or cancelling work.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["blocked until a public jobs read CLI contract exists"], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "registered route", status: "deferred", reason: "Jobs list is a custom-app read projection; no dedicated route graph entry is required in the critical slice." }, { area: "public CLI", status: "blocked", reason: "Internal runtime job sidecars are removed from the public CLI and must not be advertised as a jobs read surface." }] }),
  customAppFiche({ id: "jobs.get", system: "jobs", title: "Jobs detail", summary: "Read one framework job/run detail with redacted entity summaries through SDK/host adapters.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["blocked until a public jobs detail CLI contract exists"], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "registered route", status: "deferred", reason: "Jobs detail is a custom-app read projection; no dedicated route graph entry is required in the critical slice." }, { area: "public CLI", status: "blocked", reason: "Internal runtime job sidecars are removed from the public CLI and must not be advertised as a jobs detail surface." }] }),
  customAppFiche({ id: "jobs.events", system: "jobs", title: "Jobs events", summary: "Read job/run event summaries without granting custom apps a live stream.", operation: "read", resourceNodes: ["claw.runtime.agent", "claw.agents.runs"], routeIds: [], cli: ["blocked until a public jobs events CLI contract exists"], serviceApi: ["claw.api.runtime.jobs"], relay: ["local-only"], gaps: [{ area: "live stream", status: "deferred", reason: "Live stream execution is intentionally separated from read-only event summaries." }, { area: "public CLI", status: "blocked", reason: "Internal runtime event sidecars are removed from the public CLI and must not be advertised as a jobs events surface." }] }),
