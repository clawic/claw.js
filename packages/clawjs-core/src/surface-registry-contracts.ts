...
export const corePublicRouteValues = "/v1/chat/completions /v1/app/ /v1/connector/connect /v1/families /v1/me/devices /v1/responses /v1/secrets /v1/secrets/setup /v1/sessions/export /v1/storage /v1/storage/objects/workspace/agents/agent-a/remote/note.txt /v1/items/item-1/shares /v1/items/item-1/shares/share-1/revoke /v1/storage/shares /v1/system/status /v1/uploads /v1/workspaces".split(" ");
...
export const corePublicRoutes = [
  ...
  ["claw.api.sync.authorityHandoffs", "POST", "/v1/sync/authority-handoffs", "Authority handoff receipt contract for sync routes"],
...
export const corePrivateRouteValues = "/api/attachments /api/auth/token /api/capture /api/captures /api/chat /api/chat/feedback /api/chat/sessions/{sessionId} /api/chat/sessions/{sessionId}/generate-title /api/chat/sessions/search /api/comments /api/config/profile /api/config/reset /api/config/workspace-files /api/connectors/catalog /api/context /api/custom-fields /api/cycles /api/discover/local /api/e2e/seed /api/epics /api/export /api/field-values /api/goals /api/graph /api/hot-topics/seed /api/images /api/images/{id} /api/images/{id}/file /api/instances /api/integrations/auth /api/integrations/enable /api/integrations/gateway /api/integrations/install /api/integrations/install-stream /api/integrations/reveal /api/integrations/slack/connect /api/integrations/slack/test /api/integrations/telegram/connect /api/integrations/telegram/test /api/integrations/uninstall /api/integrations/whatsapp/cleanup /api/integrations/whatsapp/connect /api/lists /api/memory/person /api/milestones /api/monitors /api/notes/ /api/notify/actions /api/people /api/projects /api/promote /api/realtime-token /api/recurrences /api/row /api/saved-views /api/search /api/search/index /api/sections /api/seed /api/sessions /api/setup /api/skills/install /api/skills/remove /api/skills/search /api/skills/sources /api/sources/refresh /api/stats /api/telegram/account /api/templates /api/timeline /api/tools/conclude /api/tools/get/ /api/tools/search /api/tools/status /api/tts /api/tts/providers /api/users /api/activity /api/apps/{appId}/dashboard /api/apps/{appId}/assets /api/auth.test /api/chat/sessions /api/claw/status /api/companies /api/config /api/config/local /api/connectors/subscriptions /api/contacts /api/contacts/native /api/data /api/dm /api/e2e/reset /api/e2e/status /api/events /api/health /api/images/backends /api/inbox /api/inspect/preview /api/integrations/setup /api/integrations/status /api/integrations/whatsapp/chats /api/memory /api/notes /api/notify/dashboard /api/personas /api/plugins /api/routines /api/rules /api/schema /api/skills/list /api/sources /api/spaces /api/summary /api/tasks /api/tools/save /api/ui /api/usage".split(" ");
...
export const guardCoveredStableEnvVarValues = "CLAW_ACTOR_ASSERTION CLAW_ACTOR_HOST_ID CLAW_ACTOR_ID CLAW_ACTOR_KIND CLAW_ACTOR_RUN_ID CLAW_ACTOR_SESSION_ID CLAW_ACTOR_TRUSTED_KEYS CLAW_ADOPTION_CANONICITY_SELF_TEST CLAW_CHANNEL_PROCESSOR_ID CLAW_CONTEXT_AGENT_RUNS_ACTIVE CLAW_CONTEXT_BUILD_STATUS CLAW_CONTEXT_CUSTOM_METRIC CLAW_CONTEXT_SERVICE_HEALTH CLAW_CONTEXT_WEATHER_FILE CLAW_DEMO_SCENARIO CLAW_IMAGE_ALLOW_ENV_CREDENTIALS CLAW_INSTRUCTIONS CLAW_MOCK_ALLOW_EXTERNAL_IMAGES CLAW_OPENAI_IMAGE_BASE_URL CLAW_OPENAI_IMAGE_SECRET_REF CLAW_PUBLISHING_WORKER_BUDGET CLAW_PUBLISHING_WORKER_IDLE_MAX_MS CLAW_PUBLISHING_WORKER_IDLE_MIN_MS CLAW_TEST_REUSE_TOKEN CLAW_ZERO_WORK_REPORT CLAWIX_ROOT".split(" ");
...
export const clawRegisteredDdlSources = [
  ...
  "packages/clawjs/src/cli-runtime-hermes-sqlite.test.ts",
  "packages/clawjs/src/cli-runtime-hermes-tui-gateway.test.ts",
  ...
  "packages/clawjs-search/src/store-helpers.ts",
...
export const stableEventTopics: ReadonlyArray<{
  ...
  ..."workspace.initialized compat.refreshed telegram.webhook_configured models.default-set auth.login-started files.binding_synced".split(" ").map((event) => ({
