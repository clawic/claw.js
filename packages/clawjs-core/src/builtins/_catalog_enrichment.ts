...
const OBSERVATION_PATTERN = /(sample|measurement|log|result|rating|response|symptom|mood|habit|sleep|step|weight|heart|lab|dose|diagnosis|condition|episode|visit|observation|survey|evaluation|metric|event)/;
