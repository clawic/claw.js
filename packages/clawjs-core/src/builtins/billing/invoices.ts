...
export const INVOICES: BuiltinCollectionDefinition = {
  ...
  fields: [
    ...
    { name: "number", type: "text", aliases: ["invoiceNumber"] },
    { name: "totalCents", type: "number", aliases: ["invoiceTotalCents", "invoiceTotalAmountCents"] },
    { name: "subtotalCents", type: "number", aliases: ["invoiceSubtotalCents"] },
    { name: "taxCents", type: "number", aliases: ["invoiceTaxCents", "invoiceTaxAmountCents"] },
    { name: "currency", type: "text" },
    { name: "status", type: "select", required: true, options: ["draft","open","paid","void","uncollectible"] },
    { name: "paid", type: "boolean" },
    { name: "periodStart", type: "date" },
    { name: "periodEnd", type: "date" },
    { name: "dueDate", type: "date", aliases: ["invoiceDueAt"] },
    { name: "hostedInvoiceUrl", type: "text" },
    { name: "pdfUrl", type: "text", aliases: ["invoicePdfUrl"] },
