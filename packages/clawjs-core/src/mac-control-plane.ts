...
export const macAtlasCapabilitySchema = z.object({
  ...
  backend: z.object({
    strategy: z.enum(["corewlan", "coreaudio", "networksetup", "accessibility_ax", "cgwindow_observation", "shortcuts_cli", "apple_events", "system_cli", "appkit", "manual", "blocked", "mixed"]),
...
export const MAC_CONTROL_COMMAND_ROOTS: MacControlCommandRoot[] = [
  ...
  { root: "wifi", family: "network", summary: "Wi-Fi status, scan/list, connect, disconnect and power state.", canonical: true, support: "executable", relatedSurfaces: ["claw network"] },
  ...
  { root: "vpn", family: "network", summary: "VPN status and governed connection changes.", canonical: true, support: "atlas", relatedSurfaces: ["claw network"] },
  { root: "proxy", family: "network", summary: "Proxy status and governed configuration changes.", canonical: true, support: "atlas", relatedSurfaces: ["claw network"] },
  { root: "firewall", family: "network", summary: "Firewall status and governed configuration changes.", canonical: true, support: "atlas", relatedSurfaces: ["claw network"] },
  ...
  { root: "media", family: "media", summary: "Playback status and transport controls for approved local media apps.", canonical: true, support: "executable", relatedSurfaces: ["claw media audio"] },
...
export const MAC_CAPABILITY_ATLAS: MacAtlasCapability[] = [
  ...
  capability({
    ...
    action: "inject",
    label: "Inject text",
    summary: "Paste text into the focused app through a signed-host Accessibility broker with redacted planning.",
    portableFamily: "desktop.text.inject",
    platforms: ["darwin"],
    coverageState: "executable",
    sourceConfidence: "official",
    sources: [{ label: "AXUIElement", url: appleAx }, { label: "Protected Resources", url: appleProtectedResources }],
    backend: { strategy: "accessibility_ax", notes: "The signed host owns pasteboard snapshot/restore and CGEvent paste/autosend; plans redact payload content." },
    permissions: ["mac.permission.accessibility"],
    risk: "high",
    mutatesState: true,
    revert: "best_effort",
    cli: { root: "input", canonicalUsage: "claw input text inject --text <text>", relatedSurfaces: ["claw dictation", "claw apps"] },
    uiPack: "input",
    testRefs: ["packages/clawjs-core/src/mac-control-plane.test.ts", "apps/host/Tests/CommanderE2ETests/MacControlTests.swift"],
  }),
  ...([
    ["hide_all_windows", "Hide all windows", "Hide all visible application windows through the signed host.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["minimize_all_windows", "Minimize all windows", "Minimize all visible application windows through Accessibility.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["minimize_all_windows_except_frontmost", "Minimize all except frontmost", "Minimize all windows except the frontmost window.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["minimize_app_windows_except_frontmost", "Minimize app windows except frontmost", "Minimize other windows in the frontmost app.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["isolate_window", "Isolate window", "Hide other apps and minimize non-frontmost windows.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["unminimize_all_windows", "Unminimize all windows", "Restore minimized visible application windows.", "medium", ["mac.permission.accessibility"], true, "best_effort"],
    ["show_desktop", "Show desktop", "Trigger the macOS Show Desktop action.", "low", ["mac.permission.accessibility"], true, "none"],
    ["clear_clipboard", "Clear clipboard", "Clear the system pasteboard.", "high", [], true, "none"],
    ["sleep_displays", "Sleep displays", "Put connected displays to sleep with pmset behind the broker.", "medium", [], true, "none"],
    ["center_mouse_pointer", "Center mouse pointer", "Move the pointer to the center of the main display.", "low", ["mac.permission.accessibility"], true, "best_effort"],
    ["show_color_picker", "Show color picker", "Open the system color picker.", "low", [], false, "none"],
    ["toggle_dark_mode", "Toggle dark mode", "Toggle the system appearance through the signed host.", "low", ["mac.permission.automation_apple_events"], true, "best_effort"],
    ["toggle_mute_sound", "Toggle mute sound", "Toggle default output mute through CoreAudio.", "medium", [], true, "none"],
    ["keep_awake_on", "Keep awake on", "Prevent idle sleep until disabled or host exit.", "medium", [], true, "best_effort"],
    ["keep_awake_off", "Keep awake off", "Release the broker-owned keep-awake assertion.", "low", [], false, "none"],
    ["toggle_desktop_icons", "Toggle desktop icons", "Toggle Finder desktop icons and restart Finder.", "medium", [], true, "best_effort"],
    ["open_finder", "Open Finder", "Open or focus Finder.", "low", [], false, "none"],
    ["open_terminal", "Open Terminal", "Open or focus Terminal.", "medium", [], true, "none"],
    ["open_shortcuts", "Open Shortcuts", "Open or focus Shortcuts.", "low", [], false, "none"],
    ["open_passwords", "Open Passwords", "Open or focus Passwords.", "high", [], true, "none"],
    ["open_airdrop", "Open AirDrop", "Open AirDrop in Finder.", "low", ["mac.permission.automation_apple_events"], false, "none"],
    ["open_vpn_settings", "Open VPN settings", "Open the Network settings pane.", "low", [], false, "none"],
    ["open_private_relay_settings", "Open Private Relay settings", "Open the iCloud Private Relay settings pane.", "low", [], false, "none"],
    ["open_hide_my_email_settings", "Open Hide My Email settings", "Open the iCloud Hide My Email settings pane.", "low", [], false, "none"],
    ["open_keyboard_settings", "Open Keyboard settings", "Open the Keyboard settings pane.", "low", [], false, "none"],
    ["open_display_settings", "Open Display settings", "Open the Displays settings pane.", "low", [], false, "none"],
    ["open_desktop_dock_settings", "Open Desktop & Dock settings", "Open the Desktop & Dock settings pane.", "low", [], false, "none"],
    ["open_notifications_settings", "Open Notifications settings", "Open the Notifications settings pane.", "low", [], false, "none"],
    ["open_sound_settings", "Open Sound settings", "Open the Sound settings pane.", "low", [], false, "none"],
    ["open_privacy_settings", "Open Privacy settings", "Open the Privacy & Security settings pane.", "low", [], false, "none"],
  ] as const).map(([action, label, summary, risk, permissions, mutatesState, revert]) => capability({
    id: `mac.utility.${action}`,
    family: "utility",
    action,
    label,
    summary,
    portableFamily: `desktop.utility.${action}`,
    platforms: ["darwin"],
    coverageState: "executable",
    sourceConfidence: "official",
    sources: [{ label: "Apple Protected Resources", url: appleProtectedResources }],
    backend: { strategy: "mixed", notes: "Signed-host Mac Utilities adapter; direct AppleScript, tool execution, pasteboard, pointer, settings, and power assertion effects stay behind MacControlActionBroker." },
    permissions: [...permissions],
    risk,
    mutatesState,
    revert,
    cli: { root: "mac", canonicalUsage: `claw mac utility ${action.replaceAll("_", "-")}`, relatedSurfaces: ["claw mac utilities"] },
    uiPack: "utilities",
    testRefs: ["packages/clawjs-core/src/mac-control-plane.test.ts", "apps/host/Tests/CommanderE2ETests/MacControlTests.swift"],
  })),
  ...
  capability({
    id: "mac.audio.mute.status",
    family: "audio",
    action: "mute.status",
    label: "Read output mute state",
    summary: "Read default output mute state through CoreAudio inside the signed host broker.",
    portableFamily: "system.audio.get_output_mute",
    platforms: ["darwin"],
    coverageState: "executable",
    sourceConfidence: "official",
    sources: [{ label: "CoreAudio default output device mute", url: appleCoreAudio }],
    backend: { strategy: "coreaudio", notes: "The signed host reads the default output device mute property and writes a receipt." },
    permissions: [],
    risk: "read",
    mutatesState: false,
    revert: "none",
    cli: { root: "audio", canonicalUsage: "claw audio mute status", relatedSurfaces: ["claw media audio", "claw system controls"] },
    uiPack: "audio",
    testRefs: ["packages/clawjs-core/src/mac-control-plane.test.ts", "apps/host/Tests/CommanderE2ETests/MacControlTests.swift"],
  }),
  capability({
    id: "mac.audio.mute.set",
    family: "audio",
    action: "mute.set",
    label: "Set output mute",
    summary: "Set default output mute state through CoreAudio inside the signed host broker.",
    portableFamily: "system.audio.set_output_mute",
    platforms: ["darwin"],
    coverageState: "executable",
    sourceConfidence: "official",
    sources: [{ label: "CoreAudio default output device mute", url: appleCoreAudio }],
    backend: { strategy: "coreaudio", notes: "The signed host validates a boolean muted argument, applies the default output mute property, writes receipt and audit." },
    permissions: [],
    risk: "medium",
    mutatesState: true,
    revert: "none",
    cli: { root: "audio", canonicalUsage: "claw audio mute set <on|off>", relatedSurfaces: ["claw media audio", "claw system controls"] },
    uiPack: "audio",
    testRefs: ["packages/clawjs-core/src/mac-control-plane.test.ts", "apps/host/Tests/CommanderE2ETests/MacControlTests.swift"],
  }),
  ...([
    {
      ...
      summary: "Read playback state in an approved local media app through signed-host Apple Events.",
      portableFamily: "media.playback.status",
      risk: "read",
      mutatesState: false,
      canonicalUsage: "claw media playback status --app <app>",
    },
    {
      action: "pause",
      label: "Pause media playback",
      summary: "Pause playback in an approved local media app through signed-host Apple Events.",
      portableFamily: "media.playback.pause",
      risk: "medium",
      mutatesState: true,
      canonicalUsage: "claw media playback pause --app <app>",
    },
    {
      action: "resume",
      label: "Resume media playback",
      summary: "Resume playback in an approved local media app through signed-host Apple Events.",
      portableFamily: "media.playback.resume",
      risk: "medium",
      mutatesState: true,
    ...
    coverageState: "executable",
    sourceConfidence: "official",
    sources: [{ label: "Apple Events protected resource", url: appleProtectedResources }],
    backend: { strategy: "apple_events", notes: "The signed host validates the app against an approved media-app allowlist before sending Apple Events." },
    permissions: ["mac.permission.automation_apple_events"],
    risk,
    mutatesState,
    revert: "none",
    cli: { root: "media", canonicalUsage, relatedSurfaces: ["claw media audio"] },
    uiPack: "audio",
    testRefs: ["packages/clawjs-core/src/mac-control-plane.test.ts", "apps/host/Tests/CommanderE2ETests/MacControlTests.swift"],
  })),
  capability({
...
export function buildMacActionPlan(input: BuildMacActionPlanInput): MacActionPlan {
  ...
  const missingTextInjectionPayload =
    capability.id === "mac.text.inject" &&
    (typeof input.request.arguments.text !== "string" || input.request.arguments.text.trim().length === 0);
  const blockedReasons = [
    ...
    ...(missingTextInjectionPayload ? ["arguments_required:text"] : []),
...
export function assertMacControlPlaneRegistryComplete(): void {
  ...
  for (const root of ["mac", "permissions", "wifi", "window", "shortcut", "app", "audio", "media", "notification"]) {
