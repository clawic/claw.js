...
export const clawJsonSchemasV1 = {
  ...
  appStateTransactionRequest: {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "https://schemas.clawjs.ai/v1/app-state-transaction-request.schema.json",
    type: "object",
    required: ["schemaVersion", "requestId", "hostId", "operations"],
    properties: {
      schemaVersion: { const: clawContractVersionV1 },
      requestId: stringSchema,
      hostId: stringSchema,
      operations: { type: "array", minItems: 1, items: { type: "object", required: ["kind"], properties: { kind: stringSchema }, additionalProperties: true } },
  ...
  appStateSyncReceipt: {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "https://schemas.clawjs.ai/v1/app-state-sync-receipt.schema.json",
    type: "object",
    required: ["schemaVersion", "receiptId", "requestId", "hostId", "status", "operationCount", "appliedAt"],
    properties: {
      schemaVersion: { const: clawContractVersionV1 },
      ...
      appliedAt: stringSchema,
      error: {
        anyOf: [
          { type: "null" },
          { type: "object", required: ["code", "message"], properties: { code: stringSchema, message: stringSchema } },
        ],
      },
    },
  },
  appStateProjection: {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    $id: "https://schemas.clawjs.ai/v1/app-state-projection.schema.json",
    type: "object",
    required: ["schemaVersion", "projectedAt", "projects", "pinnedThreads", "titles", "archives", "sidebar", "terminalTabs"],
    properties: {
      schemaVersion: { const: clawContractVersionV1 },
      projectedAt: stringSchema,
      projects: { type: "array", items: { type: "object" } },
      pinnedThreads: { type: "array", items: { type: "object" } },
      titles: { type: "array", items: { type: "object" } },
      archives: { type: "array", items: { type: "object" } },
      sidebar: { type: "array", items: { type: "object" } },
      terminalTabs: { type: "array", items: { type: "object" } },
      receipts: { type: "array", items: { $ref: "https://schemas.clawjs.ai/v1/app-state-sync-receipt.schema.json" } },
    },
  },
