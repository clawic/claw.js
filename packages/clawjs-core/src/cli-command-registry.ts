...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "gateway", kind: "canonical", summary: "Gateway service projection and hosted/self-hosted conformance for headless or remote hosts.", usage: "gateway serve|project|conformance|agent-service", family: "runtime", securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/relay.md"], adrs: [...CLI_ADRS, "docs/adr/0022-remote-gateway-sync-redesign.md"], tests: ["packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runGatewayCli" } }),
