...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "agents", kind: "canonical", summary: "Canonical Agents V1 definitions, assignments, execution profiles, grants, memory policies, budgets, runs, gated access, assignment routing, and external identity projection.", usage: "agents list|get|upsert|delete|schema|evaluate-access|route-check|resolve-external-identity|project-support-inbox", family: "agent", securityPolicy: "local_write", tests: ["packages/clawjs/src/index-data.test.ts", "packages/clawjs/src/inspect-cli.test.ts", "packages/clawjs-core/src/agents-v1.test.ts"], source: { file: "packages/clawjs/src/v1-data-agent-entities.ts", symbol: "runAgentsCommand" } }),
