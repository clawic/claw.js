...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    command({ name: "source", kind: "canonical", summary: "Verify and activate source checkout mode for agents using ClawJS from local main instead of npm-published packages.", usage: "source status [--source-root PATH] [--json]", family: "diagnostics", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/official-trust-and-compatibility.md"], adrs: [...CLI_ADRS, "docs/adr/0051-supply-chain-security-governance.md"], tests: ["packages/clawjs/src/source-mode.test.ts", "scripts/verify-source-mode.mjs"], source: { file: "packages/clawjs/src/cli-source-command.ts", symbol: "runSourceCli" } }),
    ...
    command({ name: "host", kind: "canonical", summary: "Host registry, status, services, capabilities, permissions, logs, doctor, daemon lifecycle, domains and framework-owned appState projection/apply.", usage: "host list|register|use|status|doctor|domains|app-state", securityPolicy: "signed_host_broker", source: { file: "packages/clawjs/src/cli-host-command.ts", symbol: "runHostCli" }, relatedSurfaces: ["system capabilities"] }),
    command({ name: "system", kind: "canonical", summary: "Read-only system telemetry, signed-host snapshots, metric history, rules, widgets, provider catalog, plan-first controls and preserved capabilities alias.", usage: "system snapshot [--source host]|metrics list|history|watch|rules|widgets|providers|controls|capabilities", aliases: ["system telemetry", "system telemetry metrics", "system telemetry history", "system telemetry widgets", "system telemetry providers", "system telemetry control plan", "menu bar indicators", "context widgets"], securityPolicy: "local_read", source: { file: "packages/clawjs/src/cli-system-command.ts", symbol: "runSystemCli" }, relatedSurfaces: ["claw host capabilities", "claw monitor"] }),
    command({ name: "network", kind: "canonical", summary: "Claw-native network control plane for policy, events, rules, manifests, route enforcement, adapter readiness and review.", usage: "network status|events|rules|policy-profiles|lists|manifests|routes|adapters|suggestions|explain|doctor", family: "network", securityPolicy: "local_write", docs: NETWORK_CONTROL_DOCS, adrs: NETWORK_CONTROL_ADRS, tests: NETWORK_CONTROL_TESTS, source: { file: "packages/clawjs/src/cli-network-command.ts", symbol: "runNetworkCli" }, relatedSurfaces: ["claw gateway", "claw firewall", "claw vpn", "claw proxy", "claw wifi", "claw system metrics list"] }),
    command({ name: "mac-care", kind: "canonical", summary: "Read-only Mac Care route atlas, first-wave scanner, persisted scan history, app update/cloud provider/protection handoff and approval-ready packages, finalizer preview/approval-ready package and fixture validation scan, protection adapter contracts and engine readiness, sidecar descriptor, scan report contract, and action-plan safety policy.", usage: "mac-care report|atlas|scan|scans|app-updates handoff|app-updates approval-ready|cloud handoff|cloud approval-ready|finalizer preview|finalizer approval-ready|finalizer fixture-scan|protection adapters|protection engines|protection approval-ready|protection fixture-scan --json", family: "mac-care", securityPolicy: "local_read", tests: ["packages/clawjs-core/src/mac-care.test.ts", "packages/clawjs/src/cli-mac-care-command.test.ts", "packages/clawjs/src/index-data.test.ts"], source: { file: "packages/clawjs/src/cli-mac-care-command.ts", symbol: "runMacCareCli" }, relatedSurfaces: ["claw system metrics list", "claw permissions show files", "claw search query"] }),
    command({ name: "agent-resource", kind: "canonical", summary: "Agent coordination ledger for shared tests, app launches, fixture data, CPU budgets, and interactive resources.", usage: "agent-resource plan|acquire|heartbeat|release|status|waitlist|reap", family: "agent", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/adr/0002-testing-architecture.md"], adrs: [...CLI_ADRS, "docs/adr/0002-testing-architecture.md", "docs/adr/0004-persistent-surface-registry-and-inspection.md"], tests: ["packages/clawjs/src/cli-agent-resource-command.test.ts"], source: { file: "packages/clawjs/src/cli-agent-resource-command.ts", symbol: "runAgentResourceCli" } }),
    command({ name: "test", kind: "canonical", summary: "Coordination-aware test planning and requirement acquisition over the shared agent resource ledger.", usage: "test plan|require|status|reap", family: "diagnostics", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/testing.md", "docs/testing-matrix.md"], adrs: [...CLI_ADRS, "docs/adr/0002-testing-architecture.md"], tests: ["packages/clawjs/src/cli-agent-resource-command.test.ts"], source: { file: "packages/clawjs/src/cli-test-command.ts", symbol: "runTestCli" } }),
    ...
    command({ name: "collections", kind: "alias", target: "database", summary: "Database collections shortcut.", usage: "collections list|schema <collection>|<collection> list|get|schema", securityPolicy: "local_write" }),
    command({ name: "records", kind: "alias", target: "database", summary: "Database records shortcut.", usage: "records <collection> list|get|create|update|delete|schema|query", securityPolicy: "local_write" }),
    ...
    command({ name: "inspect", kind: "canonical", summary: "Read-only stable surface inspection.", usage: "inspect tree|list|show|neighbors|routes|route|capabilities|capability|maturity|canonicity|agent|edges|why|commands|command-intents|debt-ledger|remote|remote-sync|version-governance|evolution|governance|dense-data|dense-gaps|dense-intents|dense-views|dense-fixtures|codebase|connectors|aliases|database|storage|prefs|custom-app-sdk|contracts|apis|private-apis|protocols|events|schemas|ids|cli|env|packages|native|formats|provider-mappings|surfaces|surface-parity|external|render", adrs: [...CLI_ADRS, "docs/adr/0049-surface-route-graph.md", "docs/adr/0041-adoption-and-canonicity-governance.md", DISCOVERY_ADR], source: { file: "packages/clawjs/src/inspect-cli.ts", symbol: "runInspectCli" } }),
    command({ name: "maturity", kind: "canonical", summary: "Capability maturity registry, activation tier ceilings, activation policy, and leakage audit.", usage: "maturity list|show|audit|tier", family: "diagnostics", securityPolicy: "local_read", adrs: [...CLI_ADRS, "docs/adr/0004-persistent-surface-registry-and-inspection.md"], tests: ["packages/clawjs-core/src/capability-maturity.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs-core/src/capability-maturity.ts", symbol: "clawCapabilityMaturityRegistry" } }),
    ...
    command({ name: "get", kind: "canonical", summary: "Transversal read-only inventory view over registered nodes, resources, and worktree classes.", usage: "get nodes|resources|worktrees --json", family: "runtime", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/governance/nodes-cluster-local-forge/cluster-control-plane-checklist.md"], adrs: [...CLI_ADRS, "docs/adr/0053-nodes-and-cluster-control-plane.md"], tests: ["packages/clawjs/src/cli-remote-sync-command.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runInventoryCli" } }),
    command({ name: "describe", kind: "canonical", summary: "Transversal read-only description view for nodes and registered resources.", usage: "describe node <node-id>|resource <resource-id> --json", family: "runtime", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/governance/nodes-cluster-local-forge/cluster-control-plane-checklist.md"], adrs: [...CLI_ADRS, "docs/adr/0053-nodes-and-cluster-control-plane.md"], tests: ["packages/clawjs/src/cli-remote-sync-command.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runInventoryCli" } }),
    command({ name: "where", kind: "canonical", summary: "Transversal read-only location and authority view for nodes, projects, and resources.", usage: "where node <node-id>|project <project-id> --json", family: "runtime", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/governance/nodes-cluster-local-forge/cluster-control-plane-checklist.md"], adrs: [...CLI_ADRS, "docs/adr/0053-nodes-and-cluster-control-plane.md"], tests: ["packages/clawjs/src/cli-remote-sync-command.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runInventoryCli" } }),
    command({ name: "risk", kind: "canonical", summary: "Transversal read-only risk view for node disappearance and conservative failover blockers.", usage: "risk node <node-id> --json", family: "runtime", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/governance/nodes-cluster-local-forge/cluster-control-plane-checklist.md"], adrs: [...CLI_ADRS, "docs/adr/0053-nodes-and-cluster-control-plane.md"], tests: ["packages/clawjs/src/cli-remote-sync-command.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runInventoryCli" } }),
    ...
    command({ name: "dense-fixtures", kind: "canonical", summary: "Seed dense-data acceptance fixtures into local core.sqlite for DB and CLI coverage checks.", usage: "dense-fixtures seed", family: "database", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/governance/dense-data/decision-matrix.md"], adrs: [...CLI_ADRS, "docs/adr/0021-dense-data-operating-system.md"], tests: ["packages/clawjs/src/cli-discovery.test.ts"], source: { file: "packages/clawjs/src/cli-dense-data-command.ts", symbol: "runProfessionalRecordsCli" } }),
    command({ name: "dense-fixture", kind: "alias", target: "dense-fixtures", summary: "Singular alias for dense-data fixture seeding.", usage: "dense-fixture seed", family: "database", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/governance/dense-data/decision-matrix.md"], adrs: [...CLI_ADRS, "docs/adr/0021-dense-data-operating-system.md"], tests: ["packages/clawjs/src/cli-discovery.test.ts"], source: { file: "packages/clawjs/src/cli-dense-data-command.ts", symbol: "runProfessionalRecordsCli" } }),
    command({ name: "search", kind: "canonical", summary: "Framework-wide Search, source registry, service lifecycle, saved searches, monitors, actions, audit, source sets and deterministic local discovery.", usage: "search query|sources|status|service|rebuild|changes|saved|monitors|actions|audit|source-sets|explain", docs: ["docs/cli.md", "skills/docs-alignment-update/SKILL.md", "skills/decision-map-maintenance/SKILL.md", "skills/adr-to-guardrail/SKILL.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], source: { file: "packages/clawjs/src/index.ts", symbol: "runCliUnsafe" } }),
    command({ name: "router", kind: "canonical", summary: "Keyword router that maps free-form intent to the right dedicated command. Pass one or more keywords; returns commands, examples and anti-patterns.", usage: "router <keyword> [keyword ...] [--limit N] [--json]", family: "discovery", securityPolicy: "local_read", docs: ["docs/cli.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], tests: ["packages/clawjs/src/cli-router-command.test.ts", "packages/clawjs-core/src/discovery/keyword-router.test.ts"], source: { file: "packages/clawjs/src/cli-router-command.ts", symbol: "runCliRouterCommand" } }),
    command({ name: "about", kind: "canonical", summary: "30-second introduction to what Claw is for, with the capability map and entry commands for agents.", usage: "about [--json]", family: "discovery", securityPolicy: "local_read", docs: ["docs/cli.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], tests: ["packages/clawjs/src/cli-about-command.test.ts"], source: { file: "packages/clawjs/src/cli-about-command.ts", symbol: "runCliAboutCommand" } }),
    command({ name: "signals", kind: "canonical", summary: "Signal registry, catalog, verticals and observations backed by ClawJS canonical data.", usage: "signals registry|catalog|seed-catalog|observe|list|delete", family: "signals", securityPolicy: "local_write", source: { file: "packages/clawjs/src/v1-data.ts", symbol: "runV1DataCli" } }),
    command({ name: "life", kind: "alias", target: "signals", summary: "Life verticals alias backed by the signals registry, catalog and observations.", usage: "life registry|catalog|seed-catalog|observe|list|delete", family: "signals", securityPolicy: "local_write", tests: ["packages/clawjs/src/index-data.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/v1-data.ts", symbol: "runV1DataCli" } }),
    ...
    command({ name: "verify", kind: "canonical", summary: "Verify release evidence manifests and plugin/sub-app packages for SBOM, provenance, checksum, signature, and malware-review metadata.", usage: "verify release --manifest <file>|plugin <dir|tgz> [--json]", family: "diagnostics", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/supply-chain-security.md"], adrs: [...CLI_ADRS, "docs/adr/0051-supply-chain-security-governance.md"], tests: ["packages/clawjs/src/cli-verify-command.test.ts", "scripts/supply-chain-security-check.mjs"], source: { file: "packages/clawjs/src/cli-verify-command.ts", symbol: "runVerifyCli" } }),
    command({ name: "debt", kind: "canonical", summary: "Federated report-only debt and pending ledger for ClawJS and Clawix public artifacts.", usage: "debt list|show|audit|sources [--strict] [--severity P0|P1|P2|P3] [--release-effect blocks_release|blocks_growth|report_only]", family: "diagnostics", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/debt-ledger.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR, "docs/adr/0016-code-hygiene-program.md"], tests: ["packages/clawjs-core/src/debt-ledger.test.ts", "packages/clawjs/src/cli-debt-command.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/cli-debt-command.ts", symbol: "runDebtCli" } }),
    command({ name: "governance", kind: "canonical", summary: "Read-only governance doctor for agent routing across canon, skills, checks, stale docs, and external pending lanes.", usage: "governance doctor --json [--root PATH]", family: "diagnostics", securityPolicy: "local_read", docs: ["docs/cli.md", "docs/decision-map.md", "docs/debt-ledger.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR, "docs/adr/0027-governance-identity-scope-model.md"], tests: ["packages/clawjs/src/cli-governance-command.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/cli-governance-command.ts", symbol: "runGovernanceCli" } }),
    ...
    command({ name: "archive", kind: "canonical", summary: "Portable archive planning, local export, verification, import preview, restore report, and encrypted secrets backup gates.", usage: "archive plan|export|verify|inspect|import|restore|doctor [--include-secrets] [--signed-host] [--output PATH.clawbackup] [--archive PATH.clawbackup] [--target PATH] [--approve --confirm-restore PATH]", family: "diagnostics", securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/portable-archive-contract.md"], adrs: [...CLI_ADRS, "docs/adr/0008-secrets-security-v1.md", "docs/adr/0038-portable-archive-contract.md"], tests: ["packages/clawjs-core/src/portable-archive.test.ts", "packages/clawjs/src/index.test.ts", "scripts/portable-archive-governance-check.mjs"], source: { file: "packages/clawjs/src/cli-archive-command.ts", symbol: "runArchiveCli" }, relatedSurfaces: ["claw.format.backup", "claw.format.secrets", "claw.schema.portableArchive.manifest.v1"] }),
    ...
    command({ name: "project", kind: "canonical", summary: "Project folder manifest, attach/detach, safe handoff, path-mutable project identity, and local forge review/recovery records.", usage: "project inspect|attach|detach|export|import|sync-handoff|preflight|worktree|claim|snapshot|review|recover|forge-status", family: "work", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/workspace.md"], adrs: [...CLI_ADRS, "docs/adr/0027-governance-identity-scope-model.md", "docs/adr/0028-workspace-project-folder-manifest.md", "docs/adr/0054-local-forge-worktree-review.md"], tests: ["packages/clawjs/src/cli-project-command.test.ts"], source: { file: "packages/clawjs/src/cli-project-command.ts", symbol: "runProjectManifestCli" } }),
    ...
    command({ name: "my-work", kind: "canonical", summary: "Personal work summary.", family: "work", source: { file: "packages/clawjs/src/cli-productivity-primary-command.ts", symbol: "runPrimaryProductivityCli" } }),
    command({ name: "team-work", kind: "canonical", summary: "Team work summary.", family: "work", source: { file: "packages/clawjs/src/cli-productivity-primary-command.ts", symbol: "runPrimaryProductivityCli" } }),
    ...
    command({ name: "instructions", kind: "canonical", summary: "Unified resolver for rules, guidance, compact CLI instructions, managed Markdown instruction docs, and AGENTS/CLAUDE files.", usage: "instructions list|show|search|read|docs|graph|add|edit|rm|approve|propose|where|reconcile", family: "agent", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/decision-map.md"], adrs: [...CLI_ADRS, "docs/adr/0010-cli-jit-guidance-actor-assertions-resource-registry.md", "docs/adr/0017-discoverability-and-meta-code-routing.md"], tests: ["packages/clawjs/src/cli-instructions-command.test.ts"], source: { file: "packages/clawjs/src/cli-instructions-command.ts", symbol: "runInstructionsCli" }, relatedSurfaces: ["claw rules", "claw guidance", "claw resources", "AGENTS.md", "CLAUDE.md"] }),
    ...
    command({ name: "browser", kind: "canonical", summary: "Governed browser sessions, brokered credential/TOTP fill, human handoff, and closed encrypted profile handoff.", usage: "browser status|ensure|share|session|credential-fill", family: "runtime", advanced: true, securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/relay.md"], adrs: [...CLI_ADRS, "docs/adr/0022-remote-gateway-sync-redesign.md", "docs/adr/0053-nodes-and-cluster-control-plane.md"], tests: ["packages/clawjs/src/cli-remote-sync-command.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runBrowserCli" } }),
