...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "report", kind: "canonical", summary: "Agent-originated GitHub report governance with redaction, quality gates, dedupe, preview approval, and safe submission planning.", usage: "report draft|bug|feature|translation|security|check|dedupe|preview|submit|status|templates", family: "agent", securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/agent-rules/reporting.md"], adrs: [...CLI_ADRS, "docs/adr/0011-report-governance-v1.md"], tests: ["packages/clawjs/src/cli-report.test.ts"], source: { file: "packages/clawjs/src/cli-report-command.ts", symbol: "runReportCli" } }),
