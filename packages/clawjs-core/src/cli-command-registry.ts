...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "integrations", kind: "alias", target: "connectors", summary: "Legacy alias delegated to connectors.", family: "runtime", securityPolicy: "auth_required", docs: ["docs/cli.md", "docs/connector-control-plane.md"], adrs: [...CLI_ADRS, "docs/adr/0015-connector-control-plane-v1.md"] }),
