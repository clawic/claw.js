...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "inspect", kind: "canonical", summary: "Read-only stable surface inspection.", usage: "inspect tree|list|show|neighbors|routes|route|edges|why|commands|codebase|connectors|aliases|database|storage|prefs|contracts|apis|private-apis|protocols|events|schemas|ids|cli|env|packages|native|formats|provider-mappings|external|render", adrs: [...CLI_ADRS, "docs/adr/0012-surface-route-graph.md", DISCOVERY_ADR], source: { file: "packages/clawjs/src/inspect-cli.ts", symbol: "runInspectCli" } }),
    command({ name: "search", kind: "canonical", summary: "Framework-wide Search, source registry, saved searches, monitors, actions, audit, profiles and deterministic local discovery.", usage: "search query|sources|status|rebuild|saved|monitors|actions|audit|profiles|explain", docs: ["docs/cli.md", "skills/docs-alignment-update/SKILL.md", "skills/decision-map-maintenance/SKILL.md", "skills/adr-to-guardrail/SKILL.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], source: { file: "packages/clawjs/src/index.ts", symbol: "runCliUnsafe" } }),
    ...
    command({ name: "agents", kind: "canonical", summary: "Framework agent records and host projections.", usage: "agents list|get|upsert|delete", family: "agent", securityPolicy: "local_write", tests: ["packages/clawjs/src/index-data.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/v1-data-agent-entities.ts", symbol: "runAgentsCommand" } }),
