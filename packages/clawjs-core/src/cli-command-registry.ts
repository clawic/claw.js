...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "search", kind: "canonical", summary: "Deterministic local discovery across CLI, docs, ADRs, schemas and workspace search.", usage: "search <query>|query <workspace-query>|rebuild", docs: ["docs/cli.md", "skills/docs-alignment-update/SKILL.md", "skills/decision-map-maintenance/SKILL.md", "skills/adr-to-guardrail/SKILL.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], source: { file: "packages/clawjs/src/index.ts", symbol: "runCliUnsafe" } }),
