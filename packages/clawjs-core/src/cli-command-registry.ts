...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "project", kind: "canonical", summary: "Project folder manifest, attach/detach, safe handoff, and path-mutable project identity.", usage: "project inspect|attach|detach|export|sync-handoff", family: "work", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/workspace.md"], adrs: [...CLI_ADRS, "docs/adr/0027-governance-identity-scope-model.md", "docs/adr/0028-workspace-project-folder-manifest.md"], tests: ["packages/clawjs/src/cli-project-command.test.ts"], source: { file: "packages/clawjs/src/cli-project-command.ts", symbol: "runProjectManifestCli" } }),
    ...
    command({ name: "connectors", kind: "canonical", summary: "Strict third-party connector control plane and governed context authority.", usage: "connectors list|inspect|capabilities|policy|budgets|audit|context|ctx", family: "runtime", securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/connector-control-plane.md"], adrs: [...CLI_ADRS, "docs/adr/0015-connector-control-plane-v1.md", "docs/adr/0029-connector-governed-context-v1.md"], tests: ["packages/clawjs-core/src/connector-control-plane.test.ts", "packages/clawjs-core/src/connector-governed-context.test.ts", "packages/clawjs/src/cli-connector-context.test.ts", "packages/clawjs/src/inspect-cli.test.ts"] }),
    ...
    command({ name: "design", kind: "canonical", summary: "Framework design resource registry.", usage: "design list|upsert", family: "media", securityPolicy: "local_write", tests: ["packages/clawjs/src/index-data.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/v1-data.ts", symbol: "runV1DataCli" } }),
    command({ name: "apps", kind: "canonical", summary: "Framework app catalog and openable surface records.", usage: "apps list|upsert", family: "apps", securityPolicy: "local_write", tests: ["packages/clawjs/src/index-data.test.ts", "packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/v1-data.ts", symbol: "runV1DataCli" }, relatedSurfaces: ["claw app"] }),
    ...
    command({ name: "accounts", kind: "canonical", summary: "Human-facing governed accounts, provider resources, defaults, policies and context checks.", usage: "accounts list|schema|doctor|validate|explain|activate|pause|block|retire|edit", family: "profile", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/connector-governed-context.md"], adrs: [...CLI_ADRS, "docs/adr/0029-connector-governed-context-v1.md"], tests: ["packages/clawjs-core/src/connector-governed-context.test.ts", "packages/clawjs/src/cli-connector-context.test.ts"], source: { file: "packages/clawjs/src/cli-connector-context-command.ts", symbol: "runConnectorContextCli" } }),
    command({ name: "acct", kind: "alias", target: "accounts", summary: "Short alias for governed accounts context.", usage: "acct list|schema|doctor|validate|explain", family: "profile", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/connector-governed-context.md"], adrs: [...CLI_ADRS, "docs/adr/0029-connector-governed-context-v1.md"], tests: ["packages/clawjs/src/cli-connector-context.test.ts"], source: { file: "packages/clawjs/src/cli-connector-context-command.ts", symbol: "runConnectorContextCli" } }),
