...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "search", kind: "canonical", summary: "Framework-wide Search, source registry, saved searches, monitors, actions, profiles and deterministic local discovery.", usage: "search query|sources|status|rebuild|saved|monitors|actions|profiles|explain", docs: ["docs/cli.md", "skills/docs-alignment-update/SKILL.md", "skills/decision-map-maintenance/SKILL.md", "skills/adr-to-guardrail/SKILL.md"], adrs: [...CLI_ADRS, DISCOVERY_ADR], source: { file: "packages/clawjs/src/index.ts", symbol: "runCliUnsafe" } }),
