...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "dense-fixtures", kind: "canonical", summary: "Seed dense-data acceptance fixtures into local core.sqlite for DB and CLI coverage checks.", usage: "dense-fixtures seed", family: "database", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/governance/dense-data/decision-matrix.md"], adrs: [...CLI_ADRS, "docs/adr/0021-dense-data-operating-system.md"], tests: ["packages/clawjs/src/cli-discovery.test.ts"], source: { file: "packages/clawjs/src/cli-dense-data-command.ts", symbol: "runDenseDataCli" } }),
    command({ name: "dense-fixture", kind: "alias", target: "dense-fixtures", summary: "Singular alias for dense-data fixture seeding.", usage: "dense-fixture seed", family: "database", securityPolicy: "local_write", docs: ["docs/cli.md", "docs/governance/dense-data/decision-matrix.md"], adrs: [...CLI_ADRS, "docs/adr/0021-dense-data-operating-system.md"], tests: ["packages/clawjs/src/cli-discovery.test.ts"], source: { file: "packages/clawjs/src/cli-dense-data-command.ts", symbol: "runDenseDataCli" } }),
