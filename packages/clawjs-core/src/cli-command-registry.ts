...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "db", kind: "alias", target: "database", summary: "Exact alias for local-first database CRUD.", usage: "db <collection> list|get|create|update|delete|schema|query", aliases: ["collections", "records"], securityPolicy: "local_write", source: { file: "packages/clawjs/src/cli-productivity-command.ts", symbol: "runCoreProductivityDbCli" } }),
    command({ name: "collections", kind: "alias", target: "database", summary: "Database collections shortcut.", usage: "collections <collection> list|get|schema", securityPolicy: "local_write" }),
    ...
    command({ name: "inspect", kind: "canonical", summary: "Read-only stable surface inspection.", usage: "inspect tree|list|show|why|commands|codebase|aliases|database|storage|prefs|contracts|apis|protocols|events|schemas|ids|cli|external|render", source: { file: "packages/clawjs/src/inspect-cli.ts", symbol: "runInspectCli" } }),
    ...
    command({ name: "agenda", kind: "canonical", summary: "Agenda view.", family: "time" }),
    command({ name: "timeline", kind: "canonical", summary: "Timeline view.", family: "time" }),
    command({ name: "review", kind: "canonical", summary: "Daily/weekly review.", family: "time" }),
    ...
    command({ name: "knowledge", kind: "portal", target: "memory", summary: "Knowledge portal backed by memory.", family: "knowledge" }),
    command({ name: "profile", kind: "portal", target: "user", summary: "Profile portal backed by user.", family: "profile" }),
    command({ name: "user", kind: "canonical", summary: "User model.", family: "profile", advanced: true, securityPolicy: "local_write" }),
    command({ name: "health", kind: "portal", target: "user", summary: "User health domain.", family: "profile" }),
    command({ name: "travel", kind: "portal", target: "user", summary: "User travel domain.", family: "profile" }),
    command({ name: "career", kind: "portal", target: "user", summary: "User career domain.", family: "profile" }),
    command({ name: "family", kind: "portal", target: "user", summary: "User family domain.", family: "profile" }),
    command({ name: "legal", kind: "portal", target: "user", summary: "User legal domain.", family: "profile" }),
    command({ name: "finance", kind: "portal", target: "user", summary: "User finance domain.", family: "profile" }),
    command({ name: "location", kind: "portal", target: "user", summary: "User location domain.", family: "profile" }),
    command({ name: "accounts", kind: "portal", target: "user", summary: "User accounts domain.", family: "profile" }),
    ...
    command({ name: "mcp", kind: "canonical", summary: "MCP server catalog.", family: "runtime", advanced: true, securityPolicy: "local_write" }),
