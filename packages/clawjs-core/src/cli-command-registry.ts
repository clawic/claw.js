...
export const clawCliCommandRegistry: ClawCliCommandRegistry = {
  ...
  commands: [
    ...
    command({ name: "remote", kind: "canonical", summary: "Remote surface classification, route inspection, and conformance checks for Coordinator/Gateway/Connector access.", usage: "remote classify|check|routes|conformance", family: "runtime", securityPolicy: "signed_host_broker", docs: ["docs/cli.md", "docs/relay.md"], adrs: [...CLI_ADRS, "docs/adr/0022-remote-gateway-sync-redesign.md"], tests: ["packages/clawjs/src/inspect-cli.test.ts"], source: { file: "packages/clawjs/src/cli-remote-sync-command.ts", symbol: "runRemoteCli" } }),
