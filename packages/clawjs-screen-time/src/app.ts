...
export const DOMAIN = "screen-time" as const;
export const DEFAULT_PORT = 4708;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "SCREEN_TIME";

export interface BuildScreenTimeAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildScreenTimeApp(options: BuildScreenTimeAppOptions = {}) {
