...
export const DOMAIN = "events-attended" as const;
export const DEFAULT_PORT = 4735;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "EVENTS_ATTENDED";

export interface BuildEventsAttendedAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildEventsAttendedApp(options: BuildEventsAttendedAppOptions = {}) {
