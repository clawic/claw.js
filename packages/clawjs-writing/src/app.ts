...
export const DOMAIN = "writing" as const;
export const DEFAULT_PORT = 4726;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "WRITING";

export interface BuildWritingAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildWritingApp(options: BuildWritingAppOptions = {}) {
