...
export const DOMAIN = "restaurants" as const;
export const DEFAULT_PORT = 4734;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "RESTAURANTS";

export interface BuildRestaurantsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildRestaurantsApp(options: BuildRestaurantsAppOptions = {}) {
