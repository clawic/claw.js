...
export const DOMAIN = "substances" as const;
export const DEFAULT_PORT = 4703;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "SUBSTANCES";

export interface BuildSubstancesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSubstancesApp(options: BuildSubstancesAppOptions = {}) {
