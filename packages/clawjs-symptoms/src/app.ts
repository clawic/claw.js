...
export const DOMAIN = "symptoms" as const;
export const DEFAULT_PORT = 4712;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "SYMPTOMS";

export interface BuildSymptomsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSymptomsApp(options: BuildSymptomsAppOptions = {}) {
