...
export const DOMAIN = "conflicts" as const;
export const DEFAULT_PORT = 4738;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "CONFLICTS";

export interface BuildConflictsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildConflictsApp(options: BuildConflictsAppOptions = {}) {
