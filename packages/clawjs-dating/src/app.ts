...
export const DOMAIN = "dating" as const;
export const DEFAULT_PORT = 4739;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "DATING";

export interface BuildDatingAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildDatingApp(options: BuildDatingAppOptions = {}) {
