...
export const DOMAIN = "habits" as const;
export const DEFAULT_PORT = 4723;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "HABITS";

export interface BuildHabitsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildHabitsApp(options: BuildHabitsAppOptions = {}) {
