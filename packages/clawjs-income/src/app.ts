...
export const DOMAIN = "income" as const;
export const DEFAULT_PORT = 4759;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "INCOME";

export interface BuildIncomeAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildIncomeApp(options: BuildIncomeAppOptions = {}) {
