...
export const DOMAIN = "recipes-cooked" as const;
export const DEFAULT_PORT = 4728;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "RECIPES_COOKED";

export interface BuildRecipesCookedAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildRecipesCookedApp(options: BuildRecipesCookedAppOptions = {}) {
