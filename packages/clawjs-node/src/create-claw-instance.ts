...
export interface ClawInstance {
  capabilities: {
    list: () => ClawCapabilityDescriptor[];
    get: (id: string) => ClawCapabilityDescriptor | null;
    riskMap: (input?: { capabilityIds?: string[] }) => ClawCustomAppCapabilityRiskMap;
    source: () => string;
  };
  ...
  iot: {
    inventory: {
      ...
      things: {
        list: (options?: { homeId?: string; kind?: string; query?: string; area?: string }) => Promise<IoTDeviceDescriptor[]>;
        get: (thingId: string, homeId?: string) => Promise<IoTDeviceDescriptor | null>;
        search: (query: string, options?: { homeId?: string; kind?: string; area?: string }) => Promise<IoTDeviceDescriptor[]>;
      };
    };
    state: {
