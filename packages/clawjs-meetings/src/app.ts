...
export const DOMAIN = "meetings" as const;
export const DEFAULT_PORT = 4725;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "MEETINGS";

export interface BuildMeetingsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMeetingsApp(options: BuildMeetingsAppOptions = {}) {
