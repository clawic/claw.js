...
export const DOMAIN = "triggers" as const;
export const DEFAULT_PORT = 4720;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "TRIGGERS";

export interface BuildTriggersAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildTriggersApp(options: BuildTriggersAppOptions = {}) {
