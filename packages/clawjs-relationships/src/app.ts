...
export const DOMAIN = "relationships" as const;
export const DEFAULT_PORT = 4736;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "RELATIONSHIPS";

export interface BuildRelationshipsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildRelationshipsApp(options: BuildRelationshipsAppOptions = {}) {
