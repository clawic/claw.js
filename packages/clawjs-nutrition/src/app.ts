...
export const DOMAIN = "nutrition" as const;
export const DEFAULT_PORT = 4702;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "NUTRITION";

export interface BuildNutritionAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildNutritionApp(options: BuildNutritionAppOptions = {}) {
