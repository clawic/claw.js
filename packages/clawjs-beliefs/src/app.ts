...
export const DOMAIN = "beliefs" as const;
export const DEFAULT_PORT = 4768;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "BELIEFS";

export interface BuildBeliefsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildBeliefsApp(options: BuildBeliefsAppOptions = {}) {
