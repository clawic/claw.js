...
export const DOMAIN = "cognition" as const;
export const DEFAULT_PORT = 4761;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "COGNITION";

export interface BuildCognitionAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildCognitionApp(options: BuildCognitionAppOptions = {}) {
