...
export const DOMAIN = "health" as const;
export const DEFAULT_PORT = 4700;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "HEALTH";

export interface BuildHealthAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildHealthApp(options: BuildHealthAppOptions = {}) {
