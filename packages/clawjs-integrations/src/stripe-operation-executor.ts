...
export const STRIPE_EXTRA_ACTION_SPECS = [
  ...
  spec("cancel-refund", "POST", "refunds/{refund}/cancel", [stringField("refund", { default: "re_sample" })]),
  ...
  spec("list-billing-alerts", "GET", "billing/alerts", [...PAGE_FIELDS, stringField("alert_type", { optional: true, default: "usage_threshold" }), stringField("meter", { optional: true, default: "mtr_sample" })], { query: ["limit", "starting_after", "ending_before", "alert_type", "meter"], requiredPaths: ["object", "data"] }),
  spec("create-billing-alert", "POST", "billing/alerts", [stringField("alert_type", { default: "usage_threshold" }), stringField("title", { default: "Sample usage alert" }), objectField("usage_threshold", { gte: 100, meter: "mtr_sample" }, { optional: true })], { body: ["alert_type", "title", "usage_threshold"] }),
  spec("get-billing-alert", "GET", "billing/alerts/{id}", [stringField("id", { default: "ba_sample" })]),
  spec("activate-billing-alert", "POST", "billing/alerts/{id}/activate", [stringField("id", { default: "ba_sample" })]),
  spec("archive-billing-alert", "POST", "billing/alerts/{id}/archive", [stringField("id", { default: "ba_sample" })]),
  spec("deactivate-billing-alert", "POST", "billing/alerts/{id}/deactivate", [stringField("id", { default: "ba_sample" })]),
  spec("get-billing-credit-balance-summary", "GET", "billing/credit_balance_summary", [stringField("customer", { optional: true, default: "cus_sample" }), stringField("customer_account", { optional: true, default: "acct_sample" }), objectField("filter", { type: "applicability_scope", applicability_scope: { price_type: "metered" } })], { query: ["customer", "customer_account", "filter"] }),
  spec("list-billing-credit-balance-transactions", "GET", "billing/credit_balance_transactions", [...PAGE_FIELDS, stringField("credit_grant", { optional: true, default: "credgrant_sample" }), stringField("customer", { optional: true, default: "cus_sample" }), stringField("customer_account", { optional: true, default: "acct_sample" })], { query: ["limit", "starting_after", "ending_before", "credit_grant", "customer", "customer_account"], requiredPaths: ["object", "data"] }),
  spec("get-billing-credit-balance-transaction", "GET", "billing/credit_balance_transactions/{id}", [stringField("id", { default: "cbtxn_sample" })]),
  spec("list-billing-credit-grants", "GET", "billing/credit_grants", [...PAGE_FIELDS, stringField("customer", { optional: true, default: "cus_sample" }), stringField("customer_account", { optional: true, default: "acct_sample" })], { query: ["limit", "starting_after", "ending_before", "customer", "customer_account"], requiredPaths: ["object", "data"] }),
  spec("create-billing-credit-grant", "POST", "billing/credit_grants", [objectField("amount", { type: "monetary", monetary: { currency: "usd", value: 1000 } }), objectField("applicability_config", { scope: { price_type: "metered" } }), stringField("category", { optional: true, default: "promotional" }), stringField("customer", { optional: true, default: "cus_sample" }), stringField("customer_account", { optional: true, default: "acct_sample" }), integerField("effective_at", { optional: true, default: 1704067200 }), integerField("expires_at", { optional: true, default: 1893456000 }), objectField("metadata", { order_id: "sample" }, { optional: true }), stringField("name", { optional: true, default: "Sample credit grant" }), integerField("priority", { optional: true, default: 50 })], { body: ["amount", "applicability_config", "category", "customer", "customer_account", "effective_at", "expires_at", "metadata", "name", "priority"] }),
  spec("get-billing-credit-grant", "GET", "billing/credit_grants/{id}", [stringField("id", { default: "credgrant_sample" })]),
  spec("update-billing-credit-grant", "POST", "billing/credit_grants/{id}", [stringField("id", { default: "credgrant_sample" }), integerField("expires_at", { optional: true, default: 1893456000 }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["expires_at", "metadata"] }),
  spec("expire-billing-credit-grant", "POST", "billing/credit_grants/{id}/expire", [stringField("id", { default: "credgrant_sample" })]),
  spec("void-billing-credit-grant", "POST", "billing/credit_grants/{id}/void", [stringField("id", { default: "credgrant_sample" })]),
  spec("create-billing-meter-event-adjustment", "POST", "billing/meter_event_adjustments", [objectField("cancel", { identifier: "event_sample" }, { optional: true }), stringField("event_name", { default: "sample_meter_event" }), stringField("type", { default: "cancel" })], { body: ["cancel", "event_name", "type"] }),
  spec("create-billing-meter-event", "POST", "billing/meter_events", [stringField("event_name", { default: "sample_meter_event" }), stringField("identifier", { optional: true, default: "event_sample" }), objectField("payload", { stripe_customer_id: "cus_sample", value: "10" }), integerField("timestamp", { optional: true, default: 1704067200 })], { body: ["event_name", "identifier", "payload", "timestamp"] }),
  spec("list-billing-meters", "GET", "billing/meters", [...PAGE_FIELDS, stringField("status", { optional: true, default: "active" })], { query: ["limit", "starting_after", "ending_before", "status"], requiredPaths: ["object", "data"] }),
  spec("create-billing-meter", "POST", "billing/meters", [objectField("customer_mapping", { type: "by_id", event_payload_key: "stripe_customer_id" }, { optional: true }), objectField("default_aggregation", { formula: "sum" }), stringField("display_name", { default: "Sample billing meter" }), stringField("event_name", { default: "sample_meter_event" }), stringField("event_time_window", { optional: true, default: "hour" }), objectField("value_settings", { event_payload_key: "value" }, { optional: true })], { body: ["customer_mapping", "default_aggregation", "display_name", "event_name", "event_time_window", "value_settings"] }),
  spec("get-billing-meter", "GET", "billing/meters/{id}", [stringField("id", { default: "mtr_sample" })]),
  spec("update-billing-meter", "POST", "billing/meters/{id}", [stringField("id", { default: "mtr_sample" }), stringField("display_name", { optional: true, default: "Updated billing meter" })], { body: ["display_name"] }),
  spec("deactivate-billing-meter", "POST", "billing/meters/{id}/deactivate", [stringField("id", { default: "mtr_sample" })]),
  spec("list-billing-meter-event-summaries", "GET", "billing/meters/{id}/event_summaries", [stringField("id", { default: "mtr_sample" }), stringField("customer", { default: "cus_sample" }), integerField("start_time", { default: 1704067200 }), integerField("end_time", { default: 1704153600 }), ...PAGE_FIELDS, stringField("value_grouping_window", { optional: true, default: "hour" })], { query: ["customer", "start_time", "end_time", "limit", "starting_after", "ending_before", "value_grouping_window"], requiredPaths: ["object", "data"] }),
  spec("reactivate-billing-meter", "POST", "billing/meters/{id}/reactivate", [stringField("id", { default: "mtr_sample" })]),
  ...
  spec("create-account-bank-account", "POST", "accounts/{account}/bank_accounts", [stringField("account", { default: "acct_sample" }), stringField("external_account", { default: "btok_sample" }), objectField("metadata", { order_id: "sample" }, { optional: true }), booleanField("default_for_currency", { optional: true, default: true })], { body: ["external_account", "metadata", "default_for_currency"] }),
  spec("get-account-bank-account", "GET", "accounts/{account}/bank_accounts/{id}", [stringField("account", { default: "acct_sample" }), stringField("id", { default: "ba_sample" })]),
  spec("update-account-bank-account", "POST", "accounts/{account}/bank_accounts/{id}", [stringField("account", { default: "acct_sample" }), stringField("id", { default: "ba_sample" }), stringField("account_holder_name", { optional: true, default: "Sample Person" }), stringField("account_holder_type", { optional: true, default: "individual" }), objectField("metadata", { order_id: "sample" }, { optional: true }), booleanField("default_for_currency", { optional: true, default: true })], { body: ["account_holder_name", "account_holder_type", "metadata", "default_for_currency"] }),
  spec("delete-account-bank-account", "DELETE", "accounts/{account}/bank_accounts/{id}", [stringField("account", { default: "acct_sample" }), stringField("id", { default: "ba_sample" })], { requiredPaths: ["id", "object", "deleted"] }),
  ...
  spec("update-external-account", "POST", "external_accounts/{id}", [stringField("id", { default: "ba_sample" }), stringField("account_holder_name", { optional: true, default: "Sample Person" }), stringField("account_holder_type", { optional: true, default: "individual" }), stringField("account_type", { optional: true, default: "checking" }), booleanField("default_for_currency", { optional: true, default: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["account_holder_name", "account_holder_type", "account_type", "default_for_currency", "metadata"] }),
  ...
  spec("list-account-persons", "GET", "accounts/{account}/persons", [stringField("account", { default: "acct_sample" }), ...PAGE_FIELDS, stringField("relationship", { optional: true, default: "representative" })], { query: ["limit", "starting_after", "ending_before", "relationship"], requiredPaths: ["object", "data"] }),
  spec("create-account-persons-person", "POST", "accounts/{account}/persons", [stringField("account", { default: "acct_sample" }), stringField("first_name", { optional: true, default: "Sample" }), stringField("last_name", { optional: true, default: "Person" }), objectField("relationship", { representative: true }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["first_name", "last_name", "relationship", "metadata"] }),
  spec("get-account-persons-person", "GET", "accounts/{account}/persons/{person}", [stringField("account", { default: "acct_sample" }), stringField("person", { default: "person_sample" })]),
  spec("update-account-persons-person", "POST", "accounts/{account}/persons/{person}", [stringField("account", { default: "acct_sample" }), stringField("person", { default: "person_sample" }), stringField("first_name", { optional: true, default: "Updated" }), stringField("last_name", { optional: true, default: "Person" }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["first_name", "last_name", "metadata"] }),
  spec("delete-account-persons-person", "DELETE", "accounts/{account}/persons/{person}", [stringField("account", { default: "acct_sample" }), stringField("person", { default: "person_sample" })], { requiredPaths: ["id", "object", "deleted"] }),
  ...
  spec("create-link-account-session", "POST", "link_account_sessions", [objectField("account_holder", { type: "customer", customer: "cus_sample" }), arrayField("permissions", ["balances", "transactions"]), objectField("filters", { countries: ["US"] }, { optional: true }), arrayField("prefetch", ["balances"], { optional: true }), stringField("return_url", { optional: true, default: "https://example.invalid/return" })], { body: ["account_holder", "permissions", "filters", "prefetch", "return_url"] }),
  spec("get-link-account-session", "GET", "link_account_sessions/{session}", [stringField("session", { default: "las_sample" })]),
  spec("list-linked-accounts", "GET", "linked_accounts", [...PAGE_FIELDS, objectField("account_holder", { customer: "cus_sample" }, { optional: true }), stringField("session", { optional: true, default: "las_sample" })], { query: ["limit", "starting_after", "ending_before", "account_holder", "session"], requiredPaths: ["object", "data"] }),
  spec("get-linked-account", "GET", "linked_accounts/{account}", [stringField("account", { default: "la_sample" })]),
  spec("disconnect-linked-account", "POST", "linked_accounts/{account}/disconnect", [stringField("account", { default: "la_sample" })]),
  spec("list-linked-account-owners", "GET", "linked_accounts/{account}/owners", [stringField("account", { default: "la_sample" }), stringField("ownership", { default: "own_sample" }), ...PAGE_FIELDS], { query: ["ownership", "limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("refresh-linked-account", "POST", "linked_accounts/{account}/refresh", [stringField("account", { default: "la_sample" }), arrayField("features", ["balance", "transactions"])], { body: ["features"] }),
  spec("list-payment-attempt-records", "GET", "payment_attempt_records", [stringField("payment_record", { default: "pr_sample" }), integerField("limit", { optional: true, default: 10, min: 1, max: 100 }), stringField("startingAfter", { optional: true, default: "" })], { query: ["payment_record", "limit", "starting_after"], requiredPaths: ["object", "data"] }),
  spec("get-payment-attempt-record", "GET", "payment_attempt_records/{id}", [stringField("id", { default: "par_sample" })]),
  spec("report-payment-record-payment", "POST", "payment_records/report_payment", [integerField("amount_requested", { default: 1200 }), integerField("initiated_at", { default: 1700000000 }), objectField("payment_method_details", { type: "card" }), objectField("customer_details", { email: "person@example.invalid" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["amount_requested", "initiated_at", "payment_method_details", "customer_details", "metadata"] }),
  spec("get-payment-record", "GET", "payment_records/{id}", [stringField("id", { default: "pr_sample" })]),
  spec("report-payment-record-attempt", "POST", "payment_records/{id}/report_payment_attempt", [stringField("id", { default: "pr_sample" }), integerField("initiated_at", { default: 1700000000 }), objectField("payment_method_details", { type: "card" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["initiated_at", "payment_method_details", "metadata"] }),
  spec("report-payment-record-attempt-canceled", "POST", "payment_records/{id}/report_payment_attempt_canceled", [stringField("id", { default: "pr_sample" }), integerField("canceled_at", { default: 1700000300 }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["canceled_at", "metadata"] }),
  spec("report-payment-record-attempt-failed", "POST", "payment_records/{id}/report_payment_attempt_failed", [stringField("id", { default: "pr_sample" }), integerField("failed_at", { default: 1700000300 }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["failed_at", "metadata"] }),
  spec("report-payment-record-attempt-guaranteed", "POST", "payment_records/{id}/report_payment_attempt_guaranteed", [stringField("id", { default: "pr_sample" }), integerField("guaranteed_at", { default: 1700000300 }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["guaranteed_at", "metadata"] }),
  spec("report-payment-record-attempt-informational", "POST", "payment_records/{id}/report_payment_attempt_informational", [stringField("id", { default: "pr_sample" }), stringField("description", { optional: true, default: "Informational attempt" }), objectField("customer_details", { email: "person@example.invalid" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["description", "customer_details", "metadata"] }),
  spec("report-payment-record-refund", "POST", "payment_records/{id}/report_refund", [stringField("id", { default: "pr_sample" }), integerField("amount", { optional: true, default: 500 }), integerField("initiated_at", { optional: true, default: 1700000400 }), objectField("outcome", { type: "approved" }), objectField("processor_details", { reference: "processor_sample" }), objectField("refunded", { amount: 500 }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["amount", "initiated_at", "outcome", "processor_details", "refunded", "metadata"] }),
  ...
  spec("list-app-secrets", "GET", "apps/secrets", [objectField("scope", { type: "account" }), ...PAGE_FIELDS], { query: ["scope", "limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("create-app-secret", "POST", "apps/secrets", [stringField("name", { default: "sample_secret" }), stringField("payload", { default: "sample_payload" }), objectField("scope", { type: "account" }), integerField("expires_at", { optional: true, default: 1893456000 })], { body: ["name", "payload", "scope", "expires_at"] }),
  spec("delete-app-secret", "POST", "apps/secrets/delete", [stringField("name", { default: "sample_secret" }), objectField("scope", { type: "account" })], { body: ["name", "scope"] }),
  spec("find-app-secret", "GET", "apps/secrets/find", [stringField("name", { default: "sample_secret" }), objectField("scope", { type: "account" })], { query: ["name", "scope"] }),
  spec("list-product-features", "GET", "products/{product}/features", [stringField("product", { default: "prod_sample" }), ...PAGE_FIELDS], { query: ["limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("attach-product-feature", "POST", "products/{product}/features", [stringField("product", { default: "prod_sample" }), stringField("entitlement_feature", { default: "feat_sample" })], { body: ["entitlement_feature"] }),
  spec("get-product-feature", "GET", "products/{product}/features/{id}", [stringField("product", { default: "prod_sample" }), stringField("id", { default: "prodfeat_sample" })]),
  spec("remove-product-feature", "DELETE", "products/{product}/features/{id}", [stringField("product", { default: "prod_sample" }), stringField("id", { default: "prodfeat_sample" })], { requiredPaths: ["id", "object", "deleted"] }),
  spec("update-sigma-saved-query", "POST", "sigma/saved_queries/{id}", [stringField("id", { default: "sqrq_sample" }), stringField("name", { optional: true, default: "Sample query" }), stringField("sql", { optional: true, default: "select 1" })], { body: ["name", "sql"] }),
  spec("list-sigma-scheduled-query-runs", "GET", "sigma/scheduled_query_runs", PAGE_FIELDS, { query: ["limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("get-sigma-scheduled-query-run", "GET", "sigma/scheduled_query_runs/{scheduled_query_run}", [stringField("scheduledQueryRun", { default: "sqr_sample" })]),
  ...
  spec("create-source", "POST", "sources", [stringField("type", { default: "card" }), stringField("currency", { optional: true, default: "usd" }), integerField("amount", { optional: true, default: 1200 }), objectField("owner", { email: "person@example.invalid" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["type", "currency", "amount", "owner", "metadata"] }),
  spec("get-source", "GET", "sources/{source}", [stringField("source", { default: "src_sample" })]),
  spec("update-source", "POST", "sources/{source}", [stringField("source", { default: "src_sample" }), objectField("metadata", { order_id: "sample" }, { optional: true }), objectField("owner", { email: "person@example.invalid" }, { optional: true })], { body: ["metadata", "owner"] }),
  spec("get-source-mandate-notification", "GET", "sources/{source}/mandate_notifications/{mandateNotification}", [stringField("source", { default: "src_sample" }), stringField("mandateNotification", { default: "mn_sample" })]),
  spec("list-source-transactions", "GET", "sources/{source}/source_transactions", [stringField("source", { default: "src_sample" }), ...PAGE_FIELDS], { query: ["limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("get-source-transaction", "GET", "sources/{source}/source_transactions/{sourceTransaction}", [stringField("source", { default: "src_sample" }), stringField("sourceTransaction", { default: "srctxn_sample" })]),
  spec("verify-source", "POST", "sources/{source}/verify", [stringField("source", { default: "src_sample" }), arrayField("values", ["32", "45"])], { body: ["values"] }),
  spec("list-customer-sources", "GET", "customers/{customer}/sources", [stringField("customer", { default: "cus_sample" }), ...PAGE_FIELDS, stringField("object", { optional: true, default: "card" })], { query: ["limit", "starting_after", "ending_before", "object"], requiredPaths: ["object", "data"] }),
  spec("create-customer-source", "POST", "customers/{customer}/sources", [stringField("customer", { default: "cus_sample" }), stringField("source", { optional: true, default: "tok_visa" }), objectField("card", { token: "tok_visa" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["source", "card", "metadata"] }),
  spec("get-customer-source", "GET", "customers/{customer}/sources/{sourceId}", [stringField("customer", { default: "cus_sample" }), stringField("sourceId", { default: "card_sample" })]),
  spec("update-customer-source", "POST", "customers/{customer}/sources/{sourceId}", [stringField("customer", { default: "cus_sample" }), stringField("sourceId", { default: "card_sample" }), stringField("name", { optional: true, default: "Sample Card" }), objectField("metadata", { order_id: "sample" }, { optional: true }), objectField("owner", { name: "Sample Owner" }, { optional: true })], { body: ["name", "metadata", "owner"] }),
  spec("delete-customer-source", "DELETE", "customers/{customer}/sources/{sourceId}", [stringField("customer", { default: "cus_sample" }), stringField("sourceId", { default: "card_sample" })], { requiredPaths: ["id", "object", "deleted"] }),
  spec("verify-customer-source", "POST", "customers/{customer}/sources/{sourceId}/verify", [stringField("customer", { default: "cus_sample" }), stringField("sourceId", { default: "ba_sample" }), arrayField("amounts", [32, 45])], { body: ["amounts"] }),
  spec("create-charge", "POST", "charges", [integerField("amount", { default: 1200 }), stringField("currency", { default: "usd" }), stringField("customer", { optional: true, default: "cus_sample" }), stringField("source", { optional: true, default: "tok_visa" }), stringField("description", { optional: true, default: "Sample charge" }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["amount", "currency", "customer", "source", "description", "metadata"], requiredPaths: ["id", "object", "status"] }),
  spec("update-charge", "POST", "charges/{charge}", [stringField("charge", { default: "ch_sample" }), stringField("description", { optional: true, default: "Updated charge" }), objectField("metadata", { order_id: "sample" }, { optional: true }), stringField("receipt_email", { optional: true, default: "person@example.invalid" })], { body: ["description", "metadata", "receipt_email"], requiredPaths: ["id", "object", "status"] }),
  spec("search-charges", "GET", "charges/search", SEARCH_FIELDS, { query: ["query", "limit", "page"], requiredPaths: ["object", "data"] }),
  spec("get-charge-dispute", "GET", "charges/{charge}/dispute", [stringField("charge", { default: "ch_sample" })]),
  spec("update-charge-dispute", "POST", "charges/{charge}/dispute", [stringField("charge", { default: "ch_sample" }), objectField("evidence", { customer_name: "Sample Customer" }, { optional: true }), objectField("metadata", { order_id: "sample" }, { optional: true }), booleanField("submit", { optional: true, default: false })], { body: ["evidence", "metadata", "submit"] }),
  spec("close-charge-dispute", "POST", "charges/{charge}/dispute/close", [stringField("charge", { default: "ch_sample" })]),
  spec("refund-charge", "POST", "charges/{charge}/refund", [stringField("charge", { default: "ch_sample" }), integerField("amount", { optional: true, default: 500 }), stringField("reason", { optional: true, default: "requested_by_customer" }), objectField("metadata", { order_id: "sample" }, { optional: true }), booleanField("reverse_transfer", { optional: true, default: false })], { body: ["amount", "reason", "metadata", "reverse_transfer"] }),
  spec("list-charge-refunds", "GET", "charges/{charge}/refunds", [stringField("charge", { default: "ch_sample" }), ...PAGE_FIELDS], { query: ["limit", "starting_after", "ending_before"], requiredPaths: ["object", "data"] }),
  spec("create-charge-refund", "POST", "charges/{charge}/refunds", [stringField("charge", { default: "ch_sample" }), integerField("amount", { optional: true, default: 500 }), stringField("reason", { optional: true, default: "requested_by_customer" }), objectField("metadata", { order_id: "sample" }, { optional: true }), booleanField("refund_application_fee", { optional: true, default: false })], { body: ["amount", "reason", "metadata", "refund_application_fee"] }),
  spec("get-charge-refund", "GET", "charges/{charge}/refunds/{refund}", [stringField("charge", { default: "ch_sample" }), stringField("refund", { default: "re_sample" })]),
  spec("update-charge-refund", "POST", "charges/{charge}/refunds/{refund}", [stringField("charge", { default: "ch_sample" }), stringField("refund", { default: "re_sample" }), objectField("metadata", { order_id: "sample" }, { optional: true })], { body: ["metadata"] }),
  ...
  spec("create-preview-invoice", "POST", "invoices/create_preview", [stringField("customer", { optional: true, default: "cus_sample" }), stringField("currency", { optional: true, default: "usd" }), arrayField("invoice_items", [{ amount: 1200, currency: "usd" }], { optional: true }), stringField("subscription", { optional: true, default: "sub_sample" })], { body: ["customer", "currency", "invoice_items", "subscription"] }),
  spec("add-invoice-lines", "POST", "invoices/{invoiceId}/add_lines", [stringField("invoiceId", { default: "in_sample" }), arrayField("lines", [{ amount: 1200, currency: "usd", description: "Sample line" }]), objectField("invoice_metadata", { order_id: "sample" }, { optional: true })], { body: ["lines", "invoice_metadata"] }),
  spec("attach-invoice-payment", "POST", "invoices/{invoiceId}/attach_payment", [stringField("invoiceId", { default: "in_sample" }), stringField("payment_intent", { optional: true, default: "pi_sample" }), stringField("payment_record", { optional: true, default: "pr_sample" })], { body: ["payment_intent", "payment_record"] }),
  spec("update-invoice-line-item", "POST", "invoices/{invoiceId}/lines/{lineItemId}", [stringField("invoiceId", { default: "in_sample" }), stringField("lineItemId", { default: "il_sample" }), stringField("description", { optional: true, default: "Updated line" }), integerField("quantity", { optional: true, default: 2 })], { body: ["description", "quantity"] }),
  spec("remove-invoice-lines", "POST", "invoices/{invoiceId}/remove_lines", [stringField("invoiceId", { default: "in_sample" }), arrayField("lines", [{ id: "il_sample" }]), objectField("invoice_metadata", { order_id: "sample" }, { optional: true })], { body: ["lines", "invoice_metadata"] }),
  spec("update-invoice-lines", "POST", "invoices/{invoiceId}/update_lines", [stringField("invoiceId", { default: "in_sample" }), arrayField("lines", [{ id: "il_sample", description: "Updated line" }]), objectField("invoice_metadata", { order_id: "sample" }, { optional: true })], { body: ["lines", "invoice_metadata"] }),
...
const STRIPE_OPERATION_ALIASES: Record<string, StripeRuntimeOperation> = {
  ...
  "retrieve-app-secret": "find-app-secret",
  "retrieve-product-feature": "get-product-feature",
  "retrieve-sigma-scheduled-query-run": "get-sigma-scheduled-query-run",
  "retrieve-balance-settings": "get-balance-settings",
