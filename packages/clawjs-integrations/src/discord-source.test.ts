...
const DISCORD_SOURCE_OPERATIONS = [
  ...
  source("discord.source.channel-info", "Channel Info"),
  source("discord.source.channel-pins-update", "Channel Pins Update"),
  source("discord.source.voice-channel-status-update", "Voice Channel Status Update"),
  source("discord.source.voice-channel-start-time-update", "Voice Channel Start Time Update"),
  ...
  source("discord.source.subscription-create", "Subscription Create"),
  source("discord.source.subscription-update", "Subscription Update"),
  source("discord.source.subscription-delete", "Subscription Delete"),
