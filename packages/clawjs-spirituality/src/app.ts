...
export const DOMAIN = "spirituality" as const;
export const DEFAULT_PORT = 4776;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "SPIRITUALITY";

export interface BuildSpiritualityAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSpiritualityApp(options: BuildSpiritualityAppOptions = {}) {
