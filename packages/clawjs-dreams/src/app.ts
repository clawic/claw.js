...
export const DOMAIN = "dreams" as const;
export const DEFAULT_PORT = 4716;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "DREAMS";

export interface BuildDreamsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildDreamsApp(options: BuildDreamsAppOptions = {}) {
