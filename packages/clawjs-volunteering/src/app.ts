...
export const DOMAIN = "volunteering" as const;
export const DEFAULT_PORT = 4743;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "VOLUNTEERING";

export interface BuildVolunteeringAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildVolunteeringApp(options: BuildVolunteeringAppOptions = {}) {
