...
export const DOMAIN = "pain-map" as const;
export const DEFAULT_PORT = 4706;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PAIN_MAP";

export interface BuildPainMapAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPainMapApp(options: BuildPainMapAppOptions = {}) {
