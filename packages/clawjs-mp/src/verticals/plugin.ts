// Stable contract for mp vertical plugins.
//
...
// meetup / profile-page / want) ship inside `@clawjs/mp/verticals/core`.
// Domain plugins ship as their own npm packages (`@clawjs/mp-real-estate`,
// `@clawjs/mp-vehicle`, `@clawjs/mp-dating`, ...).
