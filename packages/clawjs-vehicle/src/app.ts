...
export const DOMAIN = "vehicle" as const;
export const DEFAULT_PORT = 4757;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "VEHICLE";

export interface BuildVehicleAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildVehicleApp(options: BuildVehicleAppOptions = {}) {
