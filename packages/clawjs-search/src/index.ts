  ...
  return [
    createFrameworkSearchSourceManifest({
      ...
      facets: [
        ...
        { id: "projectPath", label: "Project path", type: "string" },
    ...
    createFrameworkSearchSourceManifest({
      ...
      domain: "sessions",
      name: "Session events",
      resultTypes: ["session_event", "tool_call", "tool_output", "patch", "lifecycle"],
      facets: [
        { id: "sessionId", label: "Session", type: "string" },
        { id: "projectId", label: "Project", type: "string" },
        { id: "projectPath", label: "Project path", type: "string" },
        { id: "agent", label: "Agent", type: "string" },
        { id: "runtime", label: "Runtime", type: "string" },
        { id: "eventKind", label: "Event kind", type: "string" },
        { id: "eventType", label: "Event type", type: "string" },
        { id: "toolName", label: "Tool", type: "string" },
        { id: "status", label: "Status", type: "string" },
        { id: "hasDiff", label: "Has diff", type: "boolean" },
        { id: "hasFailedTool", label: "Failed tool", type: "boolean" },
