...
export const DOMAIN = "compliments" as const;
export const DEFAULT_PORT = 4779;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "COMPLIMENTS";

export interface BuildComplimentsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildComplimentsApp(options: BuildComplimentsAppOptions = {}) {
