...
function defaultClawjsDataRoot(flags) {
  const explicit = flags["data-dir"] ?? process.env.SESSIONS_DATA_DIR ?? process.env.CLAW_DATA_DIR ?? process.env.CLAW_DATA_DIR ?? process.env.CLAWIX_CLAW_DATA_DIR ?? process.env.CLAWIX_CLAW_DATA_DIR;
