...
function baseUsage() {
  return [
    ...
    "",
    "Claw is the operational memory CLI for AI agents.",
    ...
    "",
    "Start here:",
    "  claw about                     what Claw is for, in 30 seconds",
    "  claw router <terms>            find the right command from your intent",
    ...
    "",
    "Common surfaces:",
    "  Capture   claw inbox, claw notes, claw decisions",
    "  Work      claw tasks, claw projects, claw goals, claw blockers",
    "  Time      claw agenda, claw calendar, claw reminders, claw deadlines",
    "  Memory    claw knowledge, claw learning, claw outcomes",
    "  Database  claw db <collection>   (fallback for collections without a dedicated command)",
    "",
    "Setup:",
