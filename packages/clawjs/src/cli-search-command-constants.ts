...
export const SEARCH_ADMIN_COMMANDS = new Set(["sources", "status", "service", "source-sets", "entrypoints", "aliases", "saved", "monitors", "actions", "audit", "jobs", "changes", "changed", "shards", "embeddings", "explain"]);
