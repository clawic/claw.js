...
const RUNTIME_SESSION_ACTION_CONTRACTS = JSON.parse(`{
  "openclaw": [
    ...
    {"action":"pin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"openclaw.sessions.pin.native_write_back_contract"},
    {"action":"unpin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"openclaw.sessions.unpin.native_write_back_contract"},
  ...
  "codex": [
    ...
    {"action":"create","status":"blocked","authority":"runtime","writesRuntime":false,"wouldWriteRuntime":true,"persistence":"none","delegatesTo":"blocked until official runtime create contract and fixture","guard":"blocked_until_official_create_fixture","requiredEvidence":["official_create_command_or_api","non_destructive_fixture","confirmation_or_dry_run_policy","round_trip_native_list_evidence"]},
    {"action":"pin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"codex.sessions.pin.native_write_back_contract"},
    {"action":"unpin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"codex.sessions.unpin.native_write_back_contract"},
    {"action":"conflicts","status":"implemented","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay_report","delegatesTo":"ClawJS app-state local overlay reconciliation report","guard":"no_silent_overwrite_or_runtime_write_back"}
  ],
  "hermes": [
    {"action":"list","status":"degraded","statusWhenSessionPath":"implemented","statusWhenLoopbackGateway":"implemented","authority":"runtime","writesRuntime":false,"persistence":"metadata_only","persistenceWhenLoopbackGateway":"runtime_gateway_snapshot","delegatesTo":"runtime session path metadata projection","delegatesToWhenLoopbackGateway":"tui_gateway.session.list","guard":"bounded_scan_without_transcript_reads","guardWhenLoopbackGateway":"loopback_tui_gateway_read_only","officialProtocolWhenLoopbackGateway":"tui_gateway_json_rpc","officialMethodWhenLoopbackGateway":"session.list","officialContractSource":"https://hermes-agent.nousresearch.com/docs/developer-guide/programmatic-integration"},
    {"action":"preview","status":"blocked","statusWhenSessionPath":"implemented","statusWhenLoopbackGateway":"implemented","authority":"runtime","writesRuntime":false,"persistence":"none","persistenceWhenSessionPath":"bounded_local_session_preview","persistenceWhenLoopbackGateway":"runtime_gateway_snapshot","delegatesTo":"blocked until native preview contract","delegatesToWhenSessionPath":"runtime session path bounded preview","delegatesToWhenLoopbackGateway":"tui_gateway.session.history","guard":"blocked_until_preview_contract_and_content_policy","guardWhenSessionPath":"metadata_default_include_content_required","guardWhenLoopbackGateway":"loopback_tui_gateway_read_only","officialProtocolWhenLoopbackGateway":"tui_gateway_json_rpc","officialMethodWhenLoopbackGateway":"session.history","officialContractSource":"https://hermes-agent.nousresearch.com/docs/developer-guide/programmatic-integration"},
    {"action":"resolve","status":"blocked","statusWhenSessionPath":"implemented","statusWhenLoopbackGateway":"implemented","authority":"runtime","writesRuntime":false,"persistence":"none","persistenceWhenSessionPath":"bounded_local_session_resolve","persistenceWhenLoopbackGateway":"runtime_gateway_snapshot","delegatesTo":"blocked until native resolve contract","delegatesToWhenSessionPath":"runtime session path bounded resolve","delegatesToWhenLoopbackGateway":"tui_gateway.session.status","guard":"blocked_until_resolve_contract","guardWhenSessionPath":"metadata_default_no_content","guardWhenLoopbackGateway":"loopback_tui_gateway_read_only","officialProtocolWhenLoopbackGateway":"tui_gateway_json_rpc","officialMethodWhenLoopbackGateway":"session.status","officialContractSource":"https://hermes-agent.nousresearch.com/docs/developer-guide/programmatic-integration"},
    {"action":"history","status":"blocked","statusWhenSessionPath":"implemented","statusWhenLoopbackGateway":"implemented","authority":"runtime","writesRuntime":false,"persistence":"none","persistenceWhenSessionPath":"bounded_redacted_local_session_history","persistenceWhenLoopbackGateway":"runtime_gateway_snapshot","delegatesTo":"blocked until native history contract","delegatesToWhenSessionPath":"runtime session path bounded history","delegatesToWhenLoopbackGateway":"tui_gateway.session.history","guard":"blocked_until_history_contract_and_content_policy","guardWhenSessionPath":"metadata_default_include_content_required","guardWhenLoopbackGateway":"loopback_tui_gateway_read_only","officialProtocolWhenLoopbackGateway":"tui_gateway_json_rpc","officialMethodWhenLoopbackGateway":"session.history","officialContractSource":"https://hermes-agent.nousresearch.com/docs/developer-guide/programmatic-integration"},
    ...
    {"action":"pin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"hermes.sessions.pin.native_write_back_contract"},
    {"action":"unpin","status":"local_overlay_only","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay","delegatesTo":"ClawJS app-state local pin overlay","guard":"must_not_write_runtime_pin_without_official_api","nativeWriteBackStatus":"blocked_until_official_runtime_write_back_contract","officialRuntimeWriteBackContractRequired":true,"officialRuntimeWriteBackContractKnown":false,"nativeWriteBackSafeDefault":"keep_local_overlay_and_do_not_write_runtime_pin_state","userVisibleContract":"local_overlay_only_until_official_runtime_pin_api_exists","claimEffect":"blocks_native_write_back_parity_not_local_overlay","evidenceRequirementId":"hermes.sessions.unpin.native_write_back_contract"},
    {"action":"conflicts","status":"implemented","authority":"clawix_local_overlay","writesRuntime":false,"persistence":"local_pin_overlay_report","delegatesTo":"ClawJS app-state local overlay reconciliation report","guard":"no_silent_overwrite_or_runtime_write_back"}
  ]
}`);
...
function evidenceRequirementsFor(runtimeId: RuntimeAdapterId, domain: string, policy, runtimeOptions?) {
  ...
  if (writeBackPolicy.startsWith("blocked") && !writeBackContractReceipt) {
    requirements.push({
      ...
      safeDefault: "keep_read_projection_only_until_official_runtime_write_back_contract_exists",
      claimEffect: "blocks_recommended_production_native_parity",
  ...
  if (approvalGatedWritePolicy && !approvalGateReceipt) {
    ...
    requirements.push({
      ...
      safeDefault: "do_not_run_without_approval_gate_fixture",
      claimEffect: "blocks_recommended_production_native_parity",
...
function isTuiGatewaySessionRequirement(requirement): boolean {
  return String(requirement.evidenceDisposition ?? "").includes("tui_gateway")
    || String(requirement.productDecision ?? "").includes("tui_gateway")
    || String(requirement.userVisibleContract ?? "").includes("tui_gateway")
...
function isWriteBackContractRequirement(requirement): boolean {
  const id = String(requirement.id ?? "");
  return id.includes(".write_back_contract")
    || id.includes(".native_write_back_contract")
    || String(requirement.evidenceDisposition ?? "").includes("write_back_contract")
    || String(requirement.productDecision ?? "").includes("write_back_unsupported");
}
...
function runtimeEvidenceReadinessSummary({
  ...
  const writeBackContractPackets = evidenceReentryPackets
    .filter((packet) => isWriteBackContractRequirement(packet));
...
function buildSupportAudit(runtimeId: RuntimeAdapterId, payload, runtimeOptions?) {
  ...
  const closureChecklist = RUNTIME_PORTAL_DOMAIN_ORDER.map((domain) => {
    ...
    const hasTuiGatewaySessionAction = requirements.some((requirement) => isTuiGatewaySessionRequirement(requirement));
    const hasProductionTransportLifecycle = requirements.some((requirement) => requiresProductionTransportLifecycle(requirement));
    const hasWriteBackContract = requirements.some((requirement) => isWriteBackContractRequirement(requirement));
      ...
      : closureStatus === "external_pending"
        ...
        : closureStatus === "product_blocked"
          ? hasApprovalGate
            ...
            : hasTuiGatewaySessionAction
              ? "keep_unpromoted_until_tui_gateway_fixture_transport_and_native_pin_contracts_exist"
            : hasWriteBackContract
              ? "keep_read_projection_only_until_official_runtime_write_back_contract_exists"
      ...
      : closureStatus === "external_pending"
        ...
        : closureStatus === "product_blocked"
          ? hasApprovalGate
            ...
            : hasTuiGatewaySessionAction
              ? (hasProductionTransportLifecycle
                ? "attach_tui_gateway_wrapper_fixture_production_transport_policy_and_round_trip_evidence"
                : "attach_tui_gateway_wrapper_fixture_and_round_trip_evidence")
            : hasWriteBackContract
              ? "add_official_runtime_write_back_contract_fixture_and_round_trip_evidence"
...
function applyRuntimeSessionPinOverlay(input, runtimeId: RuntimeAdapterId, action: "pin" | "unpin", sessionKey: string, supportContract) {
  ...
  try {
    ...
    return {
      ...
      writeBackStatus: "blocked_until_official_runtime_write_back_contract",
      nativeWriteBackStatus: "blocked_until_official_runtime_write_back_contract",
      nativeWriteBackBlockerClass: "direct_blocker",
      officialRuntimeWriteBackContractRequired: true,
      officialRuntimeWriteBackContractKnown: false,
      ...
      riskControls: [
        "no_silent_runtime_write",
        "no_direct_runtime_store_mutation",
        "local_overlay_only_until_official_runtime_pin_api_exists",
      ],
      nativeWriteBackContract: {
        status: "blocked",
        writesRuntime: false,
