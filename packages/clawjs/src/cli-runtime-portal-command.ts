...
const RUNTIME_PORTAL_DOMAIN_POLICIES = JSON.parse(`{
  ...
  "hermes": {
    ...
    "channels": {"claim":"inventoried","nativeAuthority":"runtime","canonicalAuthority":"runtime","persistence":"secret_refs_only","relation":"gateway_projection","lossPolicy":"secret_refs_only","writeBackPolicy":"external_pending_live_accounts","validation":"external_pending_for_live_accounts","officialCommands":["hermes gateway setup","hermes gateway run","hermes gateway start","hermes gateway stop","hermes gateway restart","hermes gateway status","hermes gateway list","hermes whatsapp","hermes slack manifest","hermes pairing list","hermes pairing approve <platform> <code>","hermes webhook subscribe","hermes portal status"]},
