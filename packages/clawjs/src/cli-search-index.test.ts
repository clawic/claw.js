...
test("search rebuild indexes docs pages and refreshes resource jobs", async () => {
...
test("docs.pages event jobs refresh and tombstone individual docs", async () => {
