...
export const DOMAIN = "thoughts-raw" as const;
export const DEFAULT_PORT = 4717;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "THOUGHTS_RAW";

export interface BuildThoughtsRawAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildThoughtsRawApp(options: BuildThoughtsRawAppOptions = {}) {
