...
export const DOMAIN = "wishlist" as const;
export const DEFAULT_PORT = 4763;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "WISHLIST";

export interface BuildWishlistAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildWishlistApp(options: BuildWishlistAppOptions = {}) {
