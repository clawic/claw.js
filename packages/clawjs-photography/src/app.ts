...
export const DOMAIN = "photography" as const;
export const DEFAULT_PORT = 4727;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PHOTOGRAPHY";

export interface BuildPhotographyAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPhotographyApp(options: BuildPhotographyAppOptions = {}) {
