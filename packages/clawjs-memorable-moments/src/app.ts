...
export const DOMAIN = "memorable-moments" as const;
export const DEFAULT_PORT = 4718;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "MEMORABLE_MOMENTS";

export interface BuildMemorableMomentsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMemorableMomentsApp(options: BuildMemorableMomentsAppOptions = {}) {
