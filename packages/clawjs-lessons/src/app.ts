...
export const DOMAIN = "lessons" as const;
export const DEFAULT_PORT = 4765;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "LESSONS";

export interface BuildLessonsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildLessonsApp(options: BuildLessonsAppOptions = {}) {
