...
export const DOMAIN = "identity-values" as const;
export const DEFAULT_PORT = 4767;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "IDENTITY_VALUES";

export interface BuildIdentityValuesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildIdentityValuesApp(options: BuildIdentityValuesAppOptions = {}) {
