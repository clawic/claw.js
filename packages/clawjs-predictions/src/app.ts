...
export const DOMAIN = "predictions" as const;
export const DEFAULT_PORT = 4773;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PREDICTIONS";

export interface BuildPredictionsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPredictionsApp(options: BuildPredictionsAppOptions = {}) {
