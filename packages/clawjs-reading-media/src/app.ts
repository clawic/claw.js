...
export const DOMAIN = "reading-media" as const;
export const DEFAULT_PORT = 4730;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "READING_MEDIA";

export interface BuildReadingMediaAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildReadingMediaApp(options: BuildReadingMediaAppOptions = {}) {
