...
export const DOMAIN = "music" as const;
export const DEFAULT_PORT = 4731;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "MUSIC";

export interface BuildMusicAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMusicApp(options: BuildMusicAppOptions = {}) {
