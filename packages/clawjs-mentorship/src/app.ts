...
export const DOMAIN = "mentorship" as const;
export const DEFAULT_PORT = 4741;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "MENTORSHIP";

export interface BuildMentorshipAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMentorshipApp(options: BuildMentorshipAppOptions = {}) {
