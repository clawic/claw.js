...
export const DOMAIN = "mistakes" as const;
export const DEFAULT_PORT = 4721;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "MISTAKES";

export interface BuildMistakesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMistakesApp(options: BuildMistakesAppOptions = {}) {
