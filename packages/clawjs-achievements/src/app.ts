...
export const DOMAIN = "achievements" as const;
export const DEFAULT_PORT = 4764;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "ACHIEVEMENTS";

export interface BuildAchievementsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildAchievementsApp(options: BuildAchievementsAppOptions = {}) {
