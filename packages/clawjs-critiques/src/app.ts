...
export const DOMAIN = "critiques" as const;
export const DEFAULT_PORT = 4722;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "CRITIQUES";

export interface BuildCritiquesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildCritiquesApp(options: BuildCritiquesAppOptions = {}) {
