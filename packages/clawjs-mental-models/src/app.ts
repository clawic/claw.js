...
export const DOMAIN = "mental-models" as const;
export const DEFAULT_PORT = 4766;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "MENTAL_MODELS";

export interface BuildMentalModelsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildMentalModelsApp(options: BuildMentalModelsAppOptions = {}) {
