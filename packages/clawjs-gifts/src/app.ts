...
export const DOMAIN = "gifts" as const;
export const DEFAULT_PORT = 4752;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "GIFTS";

export interface BuildGiftsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildGiftsApp(options: BuildGiftsAppOptions = {}) {
