...
export const DOMAIN = "plants" as const;
export const DEFAULT_PORT = 4756;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PLANTS";

export interface BuildPlantsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPlantsApp(options: BuildPlantsAppOptions = {}) {
