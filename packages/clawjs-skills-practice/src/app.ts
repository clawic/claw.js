...
export const DOMAIN = "skills-practice" as const;
export const DEFAULT_PORT = 4729;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "SKILLS_PRACTICE";

export interface BuildSkillsPracticeAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSkillsPracticeApp(options: BuildSkillsPracticeAppOptions = {}) {
