...
export const DOMAIN = "hydration" as const;
export const DEFAULT_PORT = 4704;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "HYDRATION";

export interface BuildHydrationAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildHydrationApp(options: BuildHydrationAppOptions = {}) {
