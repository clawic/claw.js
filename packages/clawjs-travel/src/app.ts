...
export const DOMAIN = "travel" as const;
export const DEFAULT_PORT = 4745;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "TRAVEL";

export interface BuildTravelAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildTravelApp(options: BuildTravelAppOptions = {}) {
