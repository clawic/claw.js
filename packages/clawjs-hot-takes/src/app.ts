...
export const DOMAIN = "hot-takes" as const;
export const DEFAULT_PORT = 4770;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "HOT_TAKES";

export interface BuildHotTakesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildHotTakesApp(options: BuildHotTakesAppOptions = {}) {
