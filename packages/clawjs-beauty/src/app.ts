...
export const DOMAIN = "beauty" as const;
export const DEFAULT_PORT = 4709;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "BEAUTY";

export interface BuildBeautyAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildBeautyApp(options: BuildBeautyAppOptions = {}) {
