...
It combines configuration, lifecycle hooks, runtime support metadata, and one bundled skill so the package is clearly broader than a single capability module.

## Files

- `plugin.json`: plugin manifest with runtime support and packaged surfaces
