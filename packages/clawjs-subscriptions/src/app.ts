...
export const ENV_PREFIX = "SUBSCRIPTIONS";

export interface BuildSubscriptionsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSubscriptionsApp(options: BuildSubscriptionsAppOptions = {}) {
