...
export const DOMAIN = "weather" as const;
export const DEFAULT_PORT = 4747;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "WEATHER";

export interface BuildWeatherAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildWeatherApp(options: BuildWeatherAppOptions = {}) {
