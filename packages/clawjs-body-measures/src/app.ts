...
export const DOMAIN = "body-measures" as const;
export const DEFAULT_PORT = 4705;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "BODY_MEASURES";

export interface BuildBodyMeasuresAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildBodyMeasuresApp(options: BuildBodyMeasuresAppOptions = {}) {
