...
export const DOMAIN = "learning" as const;
export const DEFAULT_PORT = 4777;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "LEARNING";

export interface BuildLearningAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildLearningApp(options: BuildLearningAppOptions = {}) {
