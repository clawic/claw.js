...
export const DOMAIN = "gps-log" as const;
export const DEFAULT_PORT = 4746;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "GPS_LOG";

export interface BuildGpsLogAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildGpsLogApp(options: BuildGpsLogAppOptions = {}) {
