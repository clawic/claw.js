...
export const DOMAIN = "birthdays" as const;
export const DEFAULT_PORT = 4737;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "BIRTHDAYS";

export interface BuildBirthdaysAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildBirthdaysApp(options: BuildBirthdaysAppOptions = {}) {
