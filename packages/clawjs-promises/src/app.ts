...
export const DOMAIN = "promises" as const;
export const DEFAULT_PORT = 4771;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PROMISES";

export interface BuildPromisesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPromisesApp(options: BuildPromisesAppOptions = {}) {
