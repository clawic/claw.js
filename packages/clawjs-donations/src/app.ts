...
export const DOMAIN = "donations" as const;
export const DEFAULT_PORT = 4742;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "DONATIONS";

export interface BuildDonationsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildDonationsApp(options: BuildDonationsAppOptions = {}) {
