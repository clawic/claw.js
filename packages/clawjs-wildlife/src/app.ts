...
export const DOMAIN = "wildlife" as const;
export const DEFAULT_PORT = 4748;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "WILDLIFE";

export interface BuildWildlifeAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildWildlifeApp(options: BuildWildlifeAppOptions = {}) {
