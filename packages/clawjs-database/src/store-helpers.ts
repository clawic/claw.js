...
export function builtInCollections(): BuiltInCollectionSeed[] {
  return uniqueBuiltInCollections([
    ...
    },
    {
      ...
      // snippet plugged into one or more agents through Agents V1 bindings. The macOS app mirrors these
    ...
    },
    {
      ...
      fields: [
        { name: "actorAgentId", type: "relation", required: true, relation: { collectionName: "agents" } },
        { name: "subjectAgentId", type: "relation", relation: { collectionName: "agents" } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "assigneeAgentId", type: "relation", relation: { collectionName: "agents" } },
        { name: "createdByAgentId", type: "relation", relation: { collectionName: "agents" } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "authorAgentId", type: "relation", relation: { collectionName: "agents" } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "requestedByAgentId", type: "relation", relation: { collectionName: "agents" } },
