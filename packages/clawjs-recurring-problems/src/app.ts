...
export const DOMAIN = "recurring-problems" as const;
export const DEFAULT_PORT = 4719;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "RECURRING_PROBLEMS";

export interface BuildRecurringProblemsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildRecurringProblemsApp(options: BuildRecurringProblemsAppOptions = {}) {
