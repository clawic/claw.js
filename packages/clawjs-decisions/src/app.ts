...
export const DOMAIN = "decisions" as const;
export const DEFAULT_PORT = 4774;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "DECISIONS";

export interface BuildDecisionsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildDecisionsApp(options: BuildDecisionsAppOptions = {}) {
