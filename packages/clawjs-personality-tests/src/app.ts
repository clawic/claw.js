...
export const DOMAIN = "personality-tests" as const;
export const DEFAULT_PORT = 4769;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PERSONALITY_TESTS";

export interface BuildPersonalityTestsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPersonalityTestsApp(options: BuildPersonalityTestsAppOptions = {}) {
