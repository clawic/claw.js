...
export const DOMAIN = "workouts" as const;
export const DEFAULT_PORT = 4713;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "WORKOUTS";

export interface BuildWorkoutsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildWorkoutsApp(options: BuildWorkoutsAppOptions = {}) {
