// Wire envelope, Intent canonicalization, message kinds for marketplace/1.0.0.
...
export const PROTOCOL_VERSION = "marketplace/1.0.0";
...
export function decodeEnvelope(buf: Uint8Array): Envelope {
  ...
  if (!protocol.startsWith("marketplace/")) {
