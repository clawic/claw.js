...
export const DOMAIN = "stretching" as const;
export const DEFAULT_PORT = 4707;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "STRETCHING";

export interface BuildStretchingAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildStretchingApp(options: BuildStretchingAppOptions = {}) {
