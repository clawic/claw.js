...
export const DOMAIN = "yes-no" as const;
export const DEFAULT_PORT = 4772;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "YES_NO";

export interface BuildYesNoAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildYesNoApp(options: BuildYesNoAppOptions = {}) {
