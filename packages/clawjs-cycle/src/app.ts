...
export const DOMAIN = "cycle" as const;
export const DEFAULT_PORT = 4710;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "CYCLE";

export interface BuildCycleAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildCycleApp(options: BuildCycleAppOptions = {}) {
