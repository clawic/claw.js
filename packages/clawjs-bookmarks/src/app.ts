...
export const DOMAIN = "bookmarks" as const;
export const DEFAULT_PORT = 4733;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "BOOKMARKS";

export interface BuildBookmarksAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildBookmarksApp(options: BuildBookmarksAppOptions = {}) {
