...
export const DOMAIN = "emotions" as const;
export const DEFAULT_PORT = 4714;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "EMOTIONS";

export interface BuildEmotionsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildEmotionsApp(options: BuildEmotionsAppOptions = {}) {
