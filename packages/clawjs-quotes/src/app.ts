...
export const DOMAIN = "quotes" as const;
export const DEFAULT_PORT = 4775;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "QUOTES";

export interface BuildQuotesAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildQuotesApp(options: BuildQuotesAppOptions = {}) {
