...
export const DOMAIN = "comm-stats" as const;
export const DEFAULT_PORT = 4744;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "COMM_STATS";

export interface BuildCommStatsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildCommStatsApp(options: BuildCommStatsAppOptions = {}) {
