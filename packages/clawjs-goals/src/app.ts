...
export const DOMAIN = "goals" as const;
export const DEFAULT_PORT = 4762;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "GOALS";

export interface BuildGoalsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildGoalsApp(options: BuildGoalsAppOptions = {}) {
