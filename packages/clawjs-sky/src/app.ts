...
export const DOMAIN = "sky" as const;
export const DEFAULT_PORT = 4749;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "SKY";

export interface BuildSkyAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildSkyApp(options: BuildSkyAppOptions = {}) {
