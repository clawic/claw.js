...
export const DOMAIN = "time-tracking" as const;
export const DEFAULT_PORT = 4724;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "TIME_TRACKING";

export interface BuildTimeTrackingAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildTimeTrackingApp(options: BuildTimeTrackingAppOptions = {}) {
