...
export const DOMAIN = "journal" as const;
export const DEFAULT_PORT = 4715;
export const HAS_SESSIONS = true;
export const ENV_PREFIX = "JOURNAL";

export interface BuildJournalAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildJournalApp(options: BuildJournalAppOptions = {}) {
