...
export const DOMAIN = "home" as const;
export const DEFAULT_PORT = 4755;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "HOME";

export interface BuildHomeAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildHomeApp(options: BuildHomeAppOptions = {}) {
