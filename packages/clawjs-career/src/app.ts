...
export const DOMAIN = "career" as const;
export const DEFAULT_PORT = 4758;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "CAREER";

export interface BuildCareerAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildCareerApp(options: BuildCareerAppOptions = {}) {
