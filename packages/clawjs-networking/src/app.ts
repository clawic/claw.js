...
export const DOMAIN = "networking" as const;
export const DEFAULT_PORT = 4740;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "NETWORKING";

export interface BuildNetworkingAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildNetworkingApp(options: BuildNetworkingAppOptions = {}) {
