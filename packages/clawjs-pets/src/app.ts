...
export const DOMAIN = "pets" as const;
export const DEFAULT_PORT = 4754;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "PETS";

export interface BuildPetsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildPetsApp(options: BuildPetsAppOptions = {}) {
