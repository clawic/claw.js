...
export const DOMAIN = "outfits" as const;
export const DEFAULT_PORT = 4750;
export const HAS_SESSIONS = false;
export const ENV_PREFIX = "OUTFITS";

export interface BuildOutfitsAppOptions {
  configOverrides?: BuildTrackingAppOptions["configOverrides"];
}

export function buildOutfitsApp(options: BuildOutfitsAppOptions = {}) {
