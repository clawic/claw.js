...
| `chat.localDesktop` | `clawix.ui.chat` | `claw.sessions` | internal | Fixture + hermetic E2E for local desktop chat | Local desktop chat route from the Clawix human agent surface into the framework runtime and sessions service. |
