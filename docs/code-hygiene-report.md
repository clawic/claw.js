...
- Latest Knip summary: 212 files with issues; 1,075 total findings after removing clear unused workspace dependencies, normalizing root VitePress/Vue/tsx ownership, calibrating entry/project ownership for templates/public CSS/website assets/generated fixtures, removing reviewed dead one-line stubs and retired CLI bin shims, reducing Discord test catalog and Secrets crypto exports to externally imported APIs only, reducing dependency/devDependency findings to zero, and keeping reviewed dynamic runtime findings baselined.
