...
| MCQ-008 | Commander correction | Commander is prototype-only; do not let current Commander shape constrain the redesign. | ADR 0023 context/consequences. | In progress: new Mac Control Plane exists; remaining legacy Commander/native paths must be retired or registered. |
