...
| 7 | Discussions canónicas | Features route to `Ideas`, UX feedback to `Feedback`, duplicates can become canonical comments; category ids remain `EXTERNAL PENDING` for real GitHub. |
