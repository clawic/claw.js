...
description: Overview of the standalone execution-plane service for agent-authored code, runs, notebooks, workers, and deployments.
---
...
Source of truth for the product scope and internal contracts lives under [`execution-plane/`](https://github.com/clawic/clawjs/blob/main/execution-plane/README.md).
