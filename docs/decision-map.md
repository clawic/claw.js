...
| Every stored domain has an explicit route from database/storage to collections, signals, aggregates, systems, runtime services, packages, module manifests, portals/aliases, CLI, and host boundaries. | [ADR 0012: domain surface registry from database to CLI](./adr/0012-domain-surface-registry-db-to-cli.md), `packages/clawjs-core/src/domain-surface-registry.ts`, [Canonical Data Catalog](./canonical-data-catalog.md), [Signals Modules](./signals-modules.md) | Core tests and `scripts/domain-surface-registry-guard.mjs` fail missing registry coverage for collections, signals, services, storage, CLI, missing `module.json` manifests, or conceptual module package wrappers. |
