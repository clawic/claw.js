...
- `claw agents schema`, `claw agents evaluate-access`, `claw agents
  ...
  incident`, and `claw agents activity-feed`
- `@clawjs/core` policy evaluators for effective access, grant expiry,
  ...
  first-class incidents, redacted activity feeds for human consumption, formal
  escalation requests, and delegation no-laundering
