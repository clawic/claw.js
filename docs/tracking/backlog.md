...
| Service stack | Vault | Seed the first vault backlog slice | `research` | `P2` | `planned` | Tracker created | Add rows for secret catalog, policies, brokered requests, and leases | 2026-04-16 |
