...
| Service stack | Execution | Track execution work independently | `planned` | Baseline repo area and public docs already exist | Seed the first execution-specific backlog entries | - | 2026-04-16 |
