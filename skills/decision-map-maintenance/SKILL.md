...
4. When the decision introduces durable meta-code, update
   ...
   within two hops.
5. Remove stale rows only when the canonical source has been retired or superseded.
6. Run docs alignment checks or add a guard if the map should enforce a snippet.
