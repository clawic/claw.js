...
// Vault feature set under ClawJS Vault.
//
...
CREATE TABLE IF NOT EXISTS agent_grants (
  ...
  vault_capabilities_json TEXT NOT NULL DEFAULT '[]',
  reason TEXT NOT NULL,
...
export function serializeVaultMeta(meta: VaultMetaSnapshot): string {
...
export function deserializeVaultMeta(json: string): VaultMetaSnapshot {
...
export interface VaultContainerRow {
  id: string;
  tenant_id: string;
  name: string;
  icon: string | null;
...
export interface AgentGrantRow {
  ...
  vault_capabilities_json: string;
  reason: string;
  token_hash: string;
  created_at: string;
  expires_at: string;
