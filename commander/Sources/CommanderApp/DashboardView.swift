    ...
    private var onboardingCard: some View {
        GroupBox("Onboarding") {
            VStack(alignment: .leading, spacing: 12) {
                ...
                statusRow("LaunchAgent (legacy)", model.installStatus?.launchAgentInstalled == true ? "Escrito" : "Pendiente")
                statusRow("LaunchAgent loaded (legacy)", model.installStatus?.launchAgentLoaded == true ? "Cargado" : "No cargado")
