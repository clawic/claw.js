...
export class AgentGrantStore {
  ...
  issue(input: {
    ...
    const row: AgentGrantRow = {
      ...
      secrets_capabilities_json: JSON.stringify(input.secretsCapabilities),
      reason: input.reason,
      token_hash: hash,
    ...
    this.db
      .prepare(
        `INSERT INTO agent_grants (
           ...
           secrets_capabilities_json, reason, token_hash, created_at, expires_at,
